...
!(function (t, e) {
  ...
  (() => {
          ...
          !(function (t) {
            ...
            (M.extend = function (t) {
              ...
              return (
                ...
                delete s.includes,
                s.options &&
                  ((s.options = o.options ? i(o.options) : {}),
            ...
            var C = {
              ...
              _off: function (t, e, i) {
                ...
                if (this._events && (n = this._events[t]))
                  if (1 !== arguments.length)
                    if ((i === this && (i = void 0), "function" == typeof e)) {
              ...
              removeEventParent: function (t) {
                return (
                  this._eventParents && delete this._eventParents[s(t)], this
                );
              },
            ...
            (O.prototype = {
              ...
              (D.prototype = {
                ...
                pad: function (t) {
                  ...
                  return new D(
                    new R(e.lat - n, e.lng - o),
                    new R(i.lat + n, i.lng + o)
                  );
                },
                getCenter: function () {
                  return new R(
              ...
              (R.prototype = {
                ...
                toString: function (t) {
                  return (
                    "LatLng(" + l(this.lat, t) + ", " + l(this.lng, t) + ")"
                  );
                },
                distanceTo: function (t) {
            ...
            var j,
              H = {
                ...
                wrapLatLngBounds: function (t) {
                  ...
                  var s = t.getSouthWest(),
                    r = t.getNorthEast();
                  return new D(
                    new R(s.lat - n, s.lng - o),
                    new R(r.lat - n, r.lng - o)
                  );
                },
              },
              U = e({}, H, {
              ...
              W = {
                ...
                bounds: ((j = G * Math.PI), new k([-j, -j], [j, j])),
              };
            function F(t, e, i, n) {
              if (g(t))
                return (
            ...
            var $,
              ...
              ft = Q && "transition" in J,
              pt =
                "WebKitCSSMatrix" in window &&
                "m11" in new window.WebKitCSSMatrix() &&
                !ot,
              gt = "MozPerspective" in J,
              mt = !window.L_DISABLE_3D && (ft || pt || gt) && !dt && !ct,
              ...
              Nt = !(!document.createElementNS || !Y("svg").createSVGRect),
              Ot =
                !!Nt &&
            ...
            var kt = {
              ...
              At = kt.msPointer ? "MSPointerDown" : "pointerdown",
              Dt = kt.msPointer ? "MSPointerMove" : "pointermove",
              Bt = kt.msPointer ? "MSPointerUp" : "pointerup",
              Rt = kt.msPointer ? "MSPointerCancel" : "pointercancel",
              Zt = {
                touchstart: At,
                touchmove: Dt,
                touchend: Bt,
            ...
            if ("onselectstart" in document)
              ...
              (Yt = function () {
                ...
                (Xt = function () {
                  xe &&
                    ((document.documentElement.style[xe] = $t), ($t = void 0));
                });
            }
            function we() {
            ...
            function Ne(t, e, i, n) {
              if (1 === arguments.length) Oe(t), delete t[Ce];
            ...
            function ze(t, e, i, n) {
              ...
              var r = function (e) {
                ...
                a = r;
              !kt.touchNative && kt.pointer && 0 === e.indexOf("touch")
                ? (r = Gt(t, e, r))
                : kt.touch && "dblclick" === e
                ? (r = (function (t, e) {
                ...
                ? "touchstart" === e ||
                  ...
                  ? ((r = function (e) {
                      (e = e || window.event), Ge(t, e) && a(e);
                    }),
                    t.addEventListener(Ie[e], r, !1))
            ...
            function ke(t, e, i, n, o) {
              ...
              !kt.touchNative && kt.pointer && 0 === e.indexOf("touch")
                ? (function (t, e, i) {
                    Zt[e]
                      ? t.removeEventListener(Zt[e], i, !1)
                ...
                ? t.removeEventListener(Ie[e] || e, r, !1)
            ...
            function Be(t) {
              return (
                Me(t, "mousedown touchstart dblclick contextmenu", Ae),
            ...
            var We = {
              ...
              qe = N.extend({
                ...
                initialize: function (t, e) {
                  (e = d(this, e)),
                    ...
                    this._zoomAnimated &&
                      ...
                      Me(this._proxy, ie, this._catchTransitionEnd, this)),
                ...
                zoomIn: function (t, e) {
                  return (
                    (t = t || (kt.any3d ? this.options.zoomDelta : 1)),
                    ...
                    function i() {
                      ...
                      s <= 1
                        ? ((this._flyToFrame = S(i, this)),
                          this._move(
                            this.unproject(
                              n.add(o.subtract(n).multiplyBy(g(h) / l)),
                              r
                            ),
                            this.getScaleZoom(
                              a /
                                (function (t) {
                                  return a * (f(p) / f(p + u * t));
                                })(h),
                              r
                            ),
                            { flyTo: !0 }
                ...
                panInside: function (t, e) {
                  var i = z(
                    ...
                    a = A([r.min.add(i), r.max.subtract(n)]),
                    h = a.getSize();
                  if (!a.contains(s)) {
                    this._enforcingBounds = !0;
                  ...
                  return (
                    t.watch
                      ? (this._locationWatchId =
                          navigator.geolocation.watchPosition(i, o, t))
                ...
                _findEventTargets: function (t, e) {
                  ...
                  return (
                    n.length || a || o || !this.listens(e, !0) || (n = [this]),
                    n
                  );
                },
                ...
                _getMapPanePos: function () {
                  return ye(this._mapPane) || new O(0, 0);
                },
                _moved: function () {
                  var t = this._getMapPanePos();
            ...
            var Ye = Ve.extend({
                ...
                _initLayout: function () {
                  ...
                  e.setAttribute("aria-haspopup", !0), Be(e), De(e);
              ...
              Xe = Ve.extend({
                ...
                _createButton: function (t, e, i, n, o) {
                  ...
                  return (
                    ...
                    Me(s, "click", Ze),
                    Me(s, "click", o, this),
                    Me(s, "click", this._refocusOnMap, this),
                    s
                  );
                },
            ...
            var ti,
              ei = { Events: C },
              ii = kt.touch ? "touchstart mousedown" : "mousedown",
              ni = N.extend({
                ...
                enable: function () {
                  this._enabled ||
                    (Me(this._dragStartTarget, ii, this._onDown, this),
                    (this._enabled = !0));
                },
                disable: function () {
                  this._enabled &&
                    (ni._dragging === this && this.finishDrag(!0),
                    Ne(this._dragStartTarget, ii, this._onDown, this),
                    (this._enabled = !1),
                    (this._moved = !1));
                },
                _onDown: function (t) {
                    ...
                    if (t.touches && t.touches.length > 1) this._moved = !0;
                      ...
                      var e =
                          t.touches && 1 === t.touches.length
                            ? t.touches[0]
                            : t,
                        i = new O(e.clientX, e.clientY)._subtract(
                          this._startPoint
                        );
                      (i.x || i.y) &&
                ...
                finishDrag: function (t) {
                  de(document.body, "leaflet-dragging"),
                    ...
                    Ne(document, "mousemove touchmove", this._onMove, this),
                    Ne(
                      document,
            ...
            function ri(t, e, i, n, o) {
              var s,
                ...
                h = 0;
              for (r = n + 1; r <= o - 1; r++)
                (a = ci(t[r], t[n], t[o], !0)) > h && ((s = r), (h = a));
              h > i && ((e[s] = 1), ri(t, e, i, n, s), ri(t, e, i, s, o));
            }
              ...
              for (r = 0; r < 4; r++) {
                for (
                  ...
                  (a = t[o]),
                    ...
                    a._code & u
                      ? h._code & u ||
                        (((c = hi(h, a, u, e, i))._code = li(c, e)), n.push(c))
                      : (h._code & u &&
                          (((c = hi(h, a, u, e, i))._code = li(c, e)),
                          n.push(c)),
                        n.push(a));
                t = n;
              }
            ...
            var gi = { __proto__: null, clipPolygon: pi },
              mi = {
                project: function (t) {
            ...
            var Si = Pi.extend({
              ...
              Ei = M.extend({
                ...
                _getIconUrl: function (t) {
                  return (
                    (kt.retina && this.options[t + "RetinaUrl"]) ||
                    this.options[t + "Url"]
                  );
                },
              });
            var Li = Ei.extend({
                ...
                _getIconUrl: function (t) {
                  return (
                    "string" != typeof Li.imagePath &&
                      (Li.imagePath = this._detectIconPath()),
                    (this.options.imagePath || Li.imagePath) +
              ...
              Ci = Pi.extend({
                ...
                _initIcon: function () {
                  ...
                  i !== this._icon &&
                    ...
                    this.options.autoPanOnFocus &&
                      Me(i, "focus", this._panOnFocus, this);
                ...
                _removeIcon: function () {
                  this.options.riseOnHover &&
                    ...
                    this.options.autoPanOnFocus &&
                      Ne(this._icon, "focus", this._panOnFocus, this),
                    re(this._icon),
            ...
            var zi = Ni.extend({
              ...
              closestLayerPoint: function (t) {
                for (
                  ...
                  for (
                    var h = this._parts[r], l = 1, u = h.length;
                    l < u;
                    l++
                  ) {
              ...
              getCenter: function () {
                ...
                for (t = 0, n = 0; t < h - 1; t++)
                  if (
                    ((o = a[t]), (s = a[t + 1]), (n += i = o.distanceTo(s)) > e)
                  )
                    return (
                      (r = (n - e) / i),
            ...
            var ki = zi.extend({
              ...
              _convertLatLngs: function (t) {
                var e = zi.prototype._convertLatLngs.call(this, t),
                  i = e.length;
                return (
                  i >= 2 &&
                    e[0] instanceof R &&
            ...
            function Di(t, e) {
              ...
              switch (r.type) {
                ...
                case "MultiLineString":
                  return (
                    (n = Zi(a, "LineString" === r.type ? 0 : 1, u)),
                    new zi(n, e)
                  );
                case "Polygon":
                case "MultiPolygon":
                  return (
                    (n = Zi(a, "Polygon" === r.type ? 1 : 2, u)), new ki(n, e)
                  );
            ...
            function Zi(t, e, i) {
              for (var n, o = [], s = 0, r = t.length; s < r; s++)
                (n = e ? Zi(t[s], e - 1, i) : (i || Ri)(t[s])), o.push(n);
              return o;
            }
            function ji(t, e) {
            ...
            function Hi(t, e, i, n) {
              for (var o = [], s = 0, r = t.length; s < r; s++)
                o.push(e ? Hi(t[s], e - 1, i, n) : ji(t[s], n));
              return !e && i && o.push(o[0]), o;
            }
            function Ui(t, i) {
              return t.feature ? e({}, t.feature, { geometry: i }) : Gi(i);
            }
            function Gi(t) {
            ...
            var Wi = {
              toGeoJSON: function (t) {
                return Ui(this, {
                  type: "Point",
                  coordinates: ji(this.getLatLng(), t),
                });
              },
            };
            function Fi(t, e) {
            ...
            var qi = Fi,
              Vi = Pi.extend({
                ...
                initialize: function (t, e, i) {
                  (this._url = t), (this._bounds = B(e)), d(this, i);
                },
                onAdd: function () {
                  this._image ||
                    (this._initImage(),
                ...
                setBounds: function (t) {
                  return (
                    (this._bounds = B(t)), this._map && this._reset(), this
                  );
                },
                getEvents: function () {
            ...
            var $i = Xi.extend({
              ...
              openOn: function (t) {
                return (
                  ...
                  (t._popup = this),
                  Xi.prototype.openOn.call(this, t)
                );
              },
              onAdd: function (t) {
              ...
              _updateLayout: function () {
                ...
                o && n > o ? ((e.height = o + "px"), ce(t, s)) : de(t, s),
              ...
              _adjustPan: function (t) {
                if (this.options.autoPan) {
                  ...
                  var e = this._map,
                    i = parseInt(oe(this._container, "marginBottom"), 10) || 0,
                    n = this._container.offsetHeight + i,
                    o = this._containerWidth,
                    s = new O(this._containerLeft, -n - this._containerBottom);
                  s._add(ye(this._container));
                  var r = e.layerPointToContainerPoint(s),
                    a = z(this.options.autoPanPadding),
                    h = z(this.options.autoPanPaddingTopLeft || a),
                  ...
                  r.x + o + l.x > u.x && (c = r.x + o - u.x + l.x),
                    ...
                    r.y + n + l.y > u.y && (d = r.y + n - u.y + l.y),
                    r.y - d - h.y < 0 && (d = r.y - h.y),
                    (c || d) &&
                      e
                        .fire("autopanstart")
                        .panBy([c, d], { animate: t && "moveend" === t.type });
                }
              },
              _getAnchor: function () {
                return z(
            ...
            qe.mergeOptions({ closePopupOnClick: !0 }),
              qe.include({
                openPopup: function (t, e, i) {
                  return this._initOverlay($i, t, e, i).openOn(this), this;
                },
              ...
              Pi.include({
                bindPopup: function (t, e) {
                  return (
                    (this._popup = this._initOverlay($i, this._popup, t, e)),
            ...
            var tn = Pi.extend({
              ...
              bringToFront: function () {
                return (
                  this._map &&
                    (he(this._container), this._setAutoZIndex(Math.max)),
                  this
                );
              },
              bringToBack: function () {
              ...
              _setZoomTransform: function (t, e, i) {
                var n = this._map.getZoomScale(i, t.zoom),
                  o = t.origin
                    ...
                    .round();
                kt.any3d ? me(t.el, o, n) : ve(t.el, o);
              },
              _resetGrid: function () {
                var t = this._map,
                  e = t.options.crs,
                      ...
                      for (var c = o.min.y; c <= o.max.y; c++)
                        for (var d = o.min.x; d <= o.max.x; d++) {
                          ...
                          if (((_.z = this._tileZoom), this._isValidTile(_))) {
                            var f = this._tiles[this._tileCoordsToKey(_)];
                            f ? (f.current = !0) : r.push(_);
                          }
                        }
                      if (
                        (r.sort(function (t, e) {
              ...
              _addTile: function (t, e) {
                ...
                this._initTile(s),
                  this.createTile.length < 2 &&
                    S(n(this._tileReady, this, t, null, s)),
                  ve(s, i),
            ...
            var en = tn.extend({
              ...
              _tileOnLoad: function (t, e) {
                kt.ielt9 ? setTimeout(n(t, this, null, e), 0) : t(null, e);
              },
            ...
            var on = en.extend({
              ...
              initialize: function (t, i) {
                ...
                var s = (i = d(this, i)).detectRetina && kt.retina ? 2 : 1,
                  r = this.getTileSize();
            ...
            var sn = Pi.extend({
                ...
                _updateTransform: function (t, e) {
                  ...
                  kt.any3d ? me(this._container, s, i) : ve(this._container, s);
                },
                _reset: function () {
            ...
            (cn.create = un),
              (cn.pointsToPath = X),
              (Ai.geometryToLayer = Di),
              (Ai.coordsToLatLng = Ri),
              (Ai.coordsToLatLngs = Zi),
              (Ai.latLngToCoords = ji),
              (Ai.latLngsToCoords = Hi),
              (Ai.getFeature = Ui),
              (Ai.asFeature = Gi),
            ...
            var fn = Qe.extend({
              ...
              _finish: function () {
                this._moved &&
                  (re(this._box), de(this._container, "leaflet-crosshair")),
                  Xt(),
                  be(),
                  Ne(
                    document,
            ...
            qe.addInitHook("addHandler", "doubleClickZoom", pn),
              qe.mergeOptions({
                dragging: !0,
                inertia: !0,
            ...
            qe.addInitHook("addHandler", "dragging", gn),
            ...
            qe.addInitHook("addHandler", "keyboard", mn),
              qe.mergeOptions({
                scrollWheelZoom: !0,
            ...
            qe.addInitHook("addHandler", "scrollWheelZoom", vn);
            qe.mergeOptions({
            ...
            var yn = Qe.extend({
              ...
              _cancelClickPrevent: function t() {
                Ne(document, "touchend", Re),
                  Ne(document, "touchend touchcancel", t);
              },
              _cancel: function () {
            ...
            qe.addInitHook("addHandler", "tapHold", yn),
              qe.mergeOptions({ touchZoom: kt.touch, bounceAtZoomLimits: !0 });
            var xn = Qe.extend({
              addHooks: function () {
            ...
            qe.addInitHook("addHandler", "touchZoom", xn),
              (qe.BoxZoom = fn),
              (qe.DoubleClickZoom = pn),
              (qe.Drag = gn),
              (qe.Keyboard = mn),
              (qe.ScrollWheelZoom = vn),
              (qe.TapHold = yn),
              (qe.TouchZoom = xn),
              (t.Bounds = k),
              (t.Browser = kt),
    ...
    (i.m = t),
      ...
      (i.u = (t) => {
        if (79 === t) return "orb.worker.min.js";
      }),
      (i.g = (function () {
    ...
    return (
      (() => {
        ...
        class t {
          ...
          getImage(t) {
            return this._imageByUrl[t];
          }
          loadImage(t, i) {
            const n = this.getImage(t);
            if (n) return n;
            const o = new Image();
            return (
              (this._imageByUrl[t] = o),
              (o.onload = () => {
                e(o), null == i || i();
              }),
              (o.onerror = () => {
                null == i || i(new Error(`Image ${t} failed to load.`));
              }),
              (o.src = t),
              o
            );
          ...
          loadImages(t, i) {
            const n = [],
              o = new Set(t),
              s = (t) => {
                o.delete(t), 0 === o.size && (null == i || i());
              };
            for (let i = 0; i < t.length; i++) {
              const r = t[i],
                a = this._imageByUrl[r];
              if (a) {
                o.delete(r), n.push(a);
                continue;
              }
              const h = new Image();
              (this._imageByUrl[r] = h),
                (h.onload = () => {
                  e(h), s(r);
                }),
                (h.onerror = () => {
        ...
        class h {
          constructor(t, e) {
            (this.style = {}),
              ...
              (this._onLoadedImage = null == e ? void 0 : e.onLoadedImage);
          }
          clearPosition() {
            (this.position.x = void 0), (this.position.y = void 0);
          }
          getCenter() {
            return void 0 === this.position.x || void 0 === this.position.y
              ? { x: 0, y: 0 }
              : { x: this.position.x, y: this.position.y };
          }
          getRadius() {
            var t;
            return null !== (t = this.style.size) && void 0 !== t ? t : 0;
          }
          getBorderedRadius() {
          ...
          addEdge(t) {
            t.start === this.id && (this._outEdgesById[t.id] = t),
              t.end === this.id && (this._inEdgesById[t.id] = t);
          }
          removeEdge(t) {
            delete this._outEdgesById[t.id], delete this._inEdgesById[t.id];
          }
          isSelected() {
            return this.state === o.SELECTED;
          }
          isHovered() {
            return this.state === o.HOVERED;
          }
          clearState() {
            this.state = o.NONE;
          }
          ...
          includesPoint(t) {
            const e = this._isPointInBoundingBox(t);
            if (!e) return !1;
            if (this.style.shape === s.SQUARE) return e;
            const i = this.getCenter(),
              n = this.getBorderedRadius(),
              o = t.x - i.x,
              r = t.y - i.y;
            return Math.sqrt(o * o + r * r) <= n;
          }
          hasShadow() {
            var t, e, i;
            return (
              (null !== (t = this.style.shadowSize) && void 0 !== t ? t : 0) >
                0 ||
              (null !== (e = this.style.shadowOffsetX) && void 0 !== e
                ? e
                : 0) > 0 ||
              (null !== (i = this.style.shadowOffsetY) && void 0 !== i
                ? i
                : 0) > 0
            );
          }
          hasBorder() {
            var t, e;
            const i =
                (null !== (t = this.style.borderWidth) && void 0 !== t
                  ? t
                  : 0) > 0,
              n =
                (null !== (e = this.style.borderWidthSelected) && void 0 !== e
                  ? e
                  : 0) > 0;
            return i || (this.isSelected() && n);
          }
          getLabel() {
          ...
          getColor() {
            let t;
            return (
              this.style.color && (t = this.style.color),
              this.isHovered() &&
                this.style.colorHover &&
                (t = this.style.colorHover),
              this.isSelected() &&
                this.style.colorSelected &&
                (t = this.style.colorSelected),
              t
            );
          }
          getBorderWidth() {
            ...
            return (
              this.style.borderWidth &&
                ...
                (t = this.style.borderWidth),
              this.isSelected() &&
                this.style.borderWidthSelected &&
                this.style.borderWidthSelected > 0 &&
                (t = this.style.borderWidthSelected),
              t
            );
          }
          getBorderColor() {
            ...
            let t;
            return (
              this.style.borderColor && (t = this.style.borderColor),
              this.isHovered() &&
                this.style.borderColorHover &&
                (t = this.style.borderColorHover),
              this.isSelected() &&
                this.style.borderColorSelected &&
                (t = this.style.borderColorSelected.toString()),
              t
            );
          }
          getBackgroundImage() {
            var e;
            if ((null !== (e = this.style.size) && void 0 !== e ? e : 0) <= 0)
              return;
            let i;
            if (
              (this.style.imageUrl && (i = this.style.imageUrl),
              this.isSelected() &&
              ...
              return;
            return (
              t.getInstance().getImage(i) ||
              t.getInstance().loadImage(i, (t) => {
                var e;
                t ||
                  null === (e = this._onLoadedImage) ||
                  void 0 === e ||
                  e.call(this);
              })
            );
          }
          _isPointInBoundingBox(t) {
            return ((t, e) => {
              const i = t.x + t.width,
                n = t.y + t.height;
              return e.x >= t.x && e.x <= i && e.y >= t.y && e.y <= n;
        ...
        const l = (t, e, i) => {
          const n = e.x - t.x,
            o = e.y - t.y;
          let s = ((i.x - t.x) * n + (i.y - t.y) * o) / (n * n + o * o);
          s > 1 && (s = 1), s < 0 && (s = 0);
          const r = t.x + s * n,
            a = t.y + s * o,
            h = r - i.x,
        ...
        class c {
          ...
          static copy(t, e) {
            const i = c.create({
              data: t.data,
              offset:
                void 0 !== (null == e ? void 0 : e.offset)
                  ? e.offset
                  : t.offset,
              startNode: t.startNode,
              endNode: t.endNode,
            });
            return (i.state = t.state), (i.style = t.style), i;
          }
        }
        const d = (t) => t instanceof p || t instanceof g || t instanceof m;
        class _ {
          constructor(t) {
            var e;
            (this.style = {}),
              (this.state = o.NONE),
              (this._type = u.STRAIGHT),
              (this.id = t.data.id),
              (this.data = t.data),
              (this.offset = null !== (e = t.offset) && void 0 !== e ? e : 0),
              (this.startNode = t.startNode),
          ...
          isLoopback() {
            return this._type === u.LOOPBACK;
          }
          isStraight() {
            return this._type === u.STRAIGHT;
          }
          isCurved() {
            return this._type === u.CURVED;
          }
          getCenter() {
            var t, e;
            const i =
                null === (t = this.startNode) || void 0 === t
                  ? void 0
                  : t.getCenter(),
              n =
                null === (e = this.endNode) || void 0 === e
                  ? void 0
                  : e.getCenter();
            return i && n
          ...
          getDistance(t) {
            const e = this.startNode.getCenter(),
              i = this.endNode.getCenter();
            return e && i ? l(e, i, t) : 0;
          }
          getLabel() {
            return this.style.label;
          }
          ...
          getWidth() {
            let t = 0;
            return (
              void 0 !== this.style.width && (t = this.style.width),
              this.isHovered() &&
                void 0 !== this.style.widthHover &&
                (t = this.style.widthHover),
              this.isSelected() &&
                void 0 !== this.style.widthSelected &&
                (t = this.style.widthSelected),
              t
            );
          }
          getColor() {
        ...
        const f = (t) => {
          var e;
          return t.startNode.id === t.endNode.id
            ? u.LOOPBACK
            : 0 === (null !== (e = t.offset) && void 0 !== e ? e : 0)
            ? u.STRAIGHT
            : u.CURVED;
        };
        class p extends _ {
          ...
          getDistance(t) {
            var e, i;
            const n =
                null === (e = this.startNode) || void 0 === e
                  ? void 0
                  : e.getCenter(),
              o =
                null === (i = this.endNode) || void 0 === i
                  ? void 0
                  : i.getCenter();
            return n && o ? l(n, o, t) : 0;
          }
        }
        class g extends _ {
          getCenter() {
            return this.getCurvedControlPoint(2);
          }
          getDistance(t) {
            var e, i;
            const n =
              ...
              o =
                null === (i = this.endNode) || void 0 === i
                  ...
                  : i.getCenter();
            if (!n || !o) return 0;
            const s = this.getCurvedControlPoint();
            let r,
              a,
              h,
              u,
            ...
            for (a = 1; a < 10; a++)
              (h = 0.1 * a),
                ...
                (c =
                  ...
                  Math.pow(h, 2) * o.y),
                a > 0 &&
                  ((r = l({ x: _, y: f }, { x: u, y: c }, t)),
                  (d = r < d ? r : d)),
                (_ = u),
                (f = c);
            return d;
          }
          getCurvedControlPoint(t = 4) {
            var e;
            if (!this.startNode || !this.endNode) return { x: 0, y: 0 };
            const i = this.startNode.getCenter(),
              n = this.endNode.getCenter(),
              o = this.startNode.getRadius(),
              s = this.endNode.getRadius(),
              r = (i.x + n.x) / 2,
              a = (i.y + n.y) / 2,
              h = n.x - i.x,
              l = n.y - i.y,
              u = Math.sqrt(h * h + l * l),
              c = Math.max(o, s, 4),
              d = (null !== (e = this.offset) && void 0 !== e ? e : 1) * c * t;
            return { x: r + d * (l / u), y: a - d * (h / u) };
          }
        }
        class m extends _ {
          getCenter() {
            var t;
            const e = Math.abs(
                null !== (t = this.offset) && void 0 !== t ? t : 1
              ),
              i = this.getCircularData();
            return { x: i.x + i.radius, y: i.y - 5 * e };
          }
          getDistance(t) {
            const e = this.getCircularData(),
              i = e.x - t.x,
              n = e.y - t.y;
            return Math.abs(Math.sqrt(i * i + n * n) - e.radius);
          }
          getCircularData() {
            var t;
            if (!this.startNode) return { x: 0, y: 0, radius: 0 };
            const e = this.startNode.getCenter(),
              i = this.startNode.getBorderedRadius(),
              n =
                1.5 *
                i *
                Math.abs(null !== (t = this.offset) && void 0 !== t ? t : 1),
              o = i;
            return { x: e.x + n, y: e.y - 0.5 * o, radius: n };
          }
        }
        const v = (t) => {
          const e = t.start,
        ...
        class y {
          constructor(t) {
            (this.ids = []),
              ...
              (this.getId = t.getId),
              (this.sortBy = t.sortBy);
          }
          getOne(t) {
            return this.entityById.get(t);
          }
          getMany(t, e) {
            const i = [];
            for (let n = 0; n < t.length; n++) {
              const o = this.getOne(t[n]);
              void 0 !== o &&
                (((null == e ? void 0 : e.filterBy) && !e.filterBy(o)) ||
                  i.push(o));
            }
            return this.sortBy && i.sort(this.sortBy), i;
          }
          getAll(t) {
            const e = [];
            for (let i = 0; i < this.ids.length; i++) {
              const n = this.getOne(this.ids[i]);
              void 0 !== n &&
                (((null == t ? void 0 : t.filterBy) && !t.filterBy(n)) ||
                  e.push(n));
            }
            return e;
          }
          setOne(t) {
            const e = this.getId(t),
              i = !this.entityById.has(e);
            this.entityById.set(e, t), i && (this.ids.push(e), this.sort());
          }
          setMany(t) {
            this.sortBy && t.sort(this.sortBy);
            const e = [];
            for (let i = 0; i < t.length; i++) {
              const n = this.getId(t[i]);
              this.entityById.has(n) || e.push(n), this.entityById.set(n, t[i]);
            }
            (this.ids = this.ids.concat(e)), this.sort();
          }
          removeMany(t) {
            const e = new Set(t),
              i = [];
            for (let t = 0; t < this.ids.length; t++)
              e.has(this.ids[t]) || i.push(this.ids[t]);
            this.ids = i;
            for (let e = 0; e < t.length; e++) this.entityById.delete(t[e]);
          }
          removeAll() {
            (this.ids = []), this.entityById.clear();
          }
          sort() {
            this.sortBy &&
              this.ids.sort((t, e) => {
                if (!this.sortBy) return 0;
                const i = this.getOne(t),
                  n = this.getOne(e);
                return void 0 === i || void 0 === n ? 0 : this.sortBy(i, n);
              });
          }
          get size() {
        ...
        class x {
          constructor(t, e) {
            ...
            (this._nodes = new y({
              ...
              sortBy: (t, e) => {
                var i, n;
                return (
                  (null !== (i = t.style.zIndex) && void 0 !== i ? i : 0) -
                  (null !== (n = e.style.zIndex) && void 0 !== n ? n : 0)
                );
              },
            })),
              (this._edges = new y({
              ...
              (this._onLoadedImages = null == e ? void 0 : e.onLoadedImages);
            const o =
                null !== (i = null == t ? void 0 : t.nodes) && void 0 !== i
                  ? i
                  : [],
              s =
                null !== (n = null == t ? void 0 : t.edges) && void 0 !== n
                  ? n
                  : [];
            this.setup({ nodes: o, edges: s });
          }
          getNodes(t) {
            return this._nodes.getAll({ filterBy: t });
          }
          getEdges(t) {
            return this._edges.getAll({ filterBy: t });
          }
          getNodeCount() {
          ...
          getNodeById(t) {
            return this._nodes.getOne(t);
          }
          getEdgeById(t) {
            return this._edges.getOne(t);
          }
          getNodePositions() {
            const t = this.getNodes(),
              e = new Array(t.length);
            for (let i = 0; i < t.length; i++) e[i] = t[i].position;
            return e;
          }
          setNodePositions(t) {
            for (let e = 0; e < t.length; e++) {
              const i = this._nodes.getOne(t[e].id);
              i && (i.position = t[e]);
            }
          }
          getEdgePositions() {
          ...
          setDefaultStyle(t) {
            (this._defaultStyle = t), this._applyStyle();
          }
          setup(t) {
            var e, i;
            this._nodes.removeAll(), this._edges.removeAll();
            const n =
                null !== (e = null == t ? void 0 : t.nodes) && void 0 !== e
                  ? e
                  : [],
              o =
                null !== (i = null == t ? void 0 : t.edges) && void 0 !== i
                  ? i
                  : [];
            this._insertNodes(n),
              this._insertEdges(o),
          ...
          clearPositions() {
            const t = this.getNodes();
            for (let e = 0; e < t.length; e++) t[e].clearPosition();
          }
          merge(t) {
            var e, i;
            const n = null !== (e = t.nodes) && void 0 !== e ? e : [],
              o = null !== (i = t.edges) && void 0 !== i ? i : [];
            this._upsertNodes(n),
              this._upsertEdges(o),
              this._applyEdgeOffsets(),
              this._applyStyle();
          ...
          remove(t) {
            var e, i;
            const n = null !== (e = t.nodeIds) && void 0 !== e ? e : [],
              o = null !== (i = t.edgeIds) && void 0 !== i ? i : [];
            this._removeNodes(n),
              this._removeEdges(o),
              this._applyEdgeOffsets(),
              this._applyStyle();
          ...
          isEqual(t) {
            if (this.getNodeCount() !== t.getNodeCount()) return !1;
            if (this.getEdgeCount() !== t.getEdgeCount()) return !1;
            const e = this.getNodes();
            for (let i = 0; i < e.length; i++)
              if (!t.getNodeById(e[i].id)) return !1;
            const i = this.getEdges();
            for (let e = 0; e < i.length; e++)
              if (!t.getEdgeById(i[e].id)) return !1;
            return !0;
          }
          getBoundingBox() {
            const t = this.getNodes(),
              ...
              i = { x: 0, y: 0 };
            for (let n = 0; n < t.length; n++) {
              const { x: o, y: s } = t[n].getCenter();
              if (void 0 === o || void 0 === s) continue;
              const r = t[n].getBorderedRadius();
              0 !== n
                ? (o + r > i.x && (i.x = o + r),
                  o - r < e.x && (e.x = o - r),
                  s + r > i.y && (i.y = s + r),
                  s - r < e.y && (e.y = s - r))
                : ((e.x = o - r), (i.x = o + r), (e.y = s - r), (i.y = s + r));
            }
            return {
              x: e.x,
              y: e.y,
          ...
          getNearestNode(t) {
            ...
            for (let i = e.length - 1; i >= 0; i--)
              if (e[i].includesPoint(t)) return e[i];
          }
          getNearestEdge(t, e = 3) {
            let i,
              n = e;
            const o = this.getEdges();
            for (let e = 0; e < o.length; e++) {
              const s = o[e].getDistance(t);
              s <= n && ((n = s), (i = o[e]));
            }
            return i;
          }
            ...
            for (let i = 0; i < t.length; i++)
              e[i] = r.create(
                { data: t[i] },
                {
                  onLoadedImage: () => {
                    var t;
                    return null === (t = this._onLoadedImages) || void 0 === t
                      ? void 0
                      : t.call(this);
                  },
                }
              );
            this._nodes.setMany(e);
          }
          _insertEdges(t) {
            const e = [];
            for (let i = 0; i < t.length; i++) {
              const n = this.getNodeById(t[i].start),
                o = this.getNodeById(t[i].end);
              n &&
                o &&
                e.push(c.create({ data: t[i], startNode: n, endNode: o }));
            }
            this._edges.setMany(e);
          }
          _upsertNodes(t) {
            const e = [];
            for (let i = 0; i < t.length; i++) {
              const n = this.getNodeById(t[i].id);
              n
                ? (n.data = t[i])
                : e.push(
                    r.create(
                      { data: t[i] },
                      {
                        onLoadedImage: () => {
                          var t;
                          return null === (t = this._onLoadedImages) ||
                            void 0 === t
                            ? void 0
                            : t.call(this);
                        },
          ...
          _upsertEdges(t) {
            ...
            for (let n = 0; n < t.length; n++) {
              const o = t[n],
                s = this.getEdgeById(o.id);
              if (!s) {
                const t = this.getNodeById(o.start),
                  i = this.getNodeById(o.end);
                if (t && i) {
                  const n = c.create({ data: o, startNode: t, endNode: i });
                  e.push(n);
                }
                continue;
              }
              ...
              s.startNode.removeEdge(s), s.endNode.removeEdge(s);
              const r = this.getNodeById(o.start),
                a = this.getNodeById(o.end);
              if (!r || !a) {
                i.push(s.id);
                continue;
              }
              ...
              (h.state = s.state), (h.style = s.style), e.push(h);
            }
            this._edges.setMany(e), this._edges.removeMany(i);
          }
          _removeNodes(t) {
            const e = [],
              i = [];
            for (let n = 0; n < t.length; n++) {
              const o = this.getNodeById(t[n]);
              if (!o) continue;
              const s = o.getEdges();
              for (let t = 0; t < s.length; t++) {
                const e = s[t];
                e.startNode.removeEdge(e),
                  e.endNode.removeEdge(e),
                  i.push(e.id);
              }
              e.push(o.id);
            }
            this._nodes.removeMany(e), this._edges.removeMany(i);
          }
          _removeEdges(t) {
            const e = [];
            for (let i = 0; i < t.length; i++) {
              const n = this.getEdgeById(t[i]);
              n &&
                (n.startNode.removeEdge(n),
                n.endNode.removeEdge(n),
                e.push(n.id));
            }
            this._edges.removeMany(e);
          }
          _applyEdgeOffsets() {
            const t = this.getEdges(),
              e = ((t) => {
                ...
                const i = new Array(t.length),
                  n = ((t) => {
                    ...
                    for (let o = 0; o < t.length; o++) {
                      const s = v(t[o]);
                      t[o].start === t[o].end && n.add(s),
                        (i[s] =
                          (null !== (e = i[s]) && void 0 !== e ? e : 0) + 1);
                    }
                    const o = {},
                      s = Object.keys(i);
                    for (let t = 0; t < s.length; t++) {
                      const e = s[t],
                        r = i[e];
                      if (n.has(e)) {
                        o[e] = Array.from({ length: r }, (t, e) => e + 1);
                        continue;
                      }
                      if (r <= 1) continue;
                      const a = [];
            ...
            for (let n = 0; n < e.length; n++) {
              const o = t[n],
                s = e[n];
              i[n] = c.copy(o, { offset: s });
            }
            this._edges.setMany(i);
          }
          _applyStyle() {
            var e, i;
            const n = new Set();
            if (
              null === (e = this._defaultStyle) || void 0 === e
                ? void 0
                : e.getNodeStyle
            ) {
              const t = this.getNodes();
              for (let e = 0; e < t.length; e++) {
                if (t[e].hasStyle()) continue;
                const i = this._defaultStyle.getNodeStyle(t[e]);
                i &&
                  ((t[e].style = i),
                  i.imageUrl && n.add(i.imageUrl),
                  i.imageUrlSelected && n.add(i.imageUrlSelected));
              }
            }
            if (
              null === (i = this._defaultStyle) || void 0 === i
                ? void 0
                : i.getEdgeStyle
            ) {
              const t = this.getEdges();
              for (let e = 0; e < t.length; e++) {
                if (t[e].hasStyle()) continue;
                const i = this._defaultStyle.getEdgeStyle(t[e]);
                i && (t[e].style = i);
              }
            }
            n.size &&
              t.getInstance().loadImages(Array.from(n), () => {
                var t;
                null === (t = this._onLoadedImages) ||
                  void 0 === t ||
                  t.call(this);
              }),
              this._nodes.sort(),
        ...
        var w = { value: () => {} };
        function b() {
          for (var t, e = 0, i = arguments.length, n = {}; e < i; ++e) {
        ...
        function T(t, e, i) {
          for (var n = 0, o = t.length; n < o; ++n)
            if (t[n].name === e) {
              (t[n] = w), (t = t.slice(0, n).concat(t.slice(n + 1)));
              break;
            }
        ...
        P.prototype = b.prototype = {
          ...
          on: function (t, e) {
            ...
            if (!(arguments.length < 2)) {
              ...
              for (; ++r < a; )
                if ((i = (t = s[r]).type)) o[i] = T(o[i], t.name, e);
                else if (null == e) for (i in o) o[i] = T(o[i], t.name, null);
              return this;
            }
            for (; ++r < a; )
              if ((i = (t = s[r]).type) && (i = S(o[i], t.name))) return i;
          },
          copy: function () {
            var t = {},
              e = this._;
          ...
          call: function (t, e) {
            if ((i = arguments.length - 2) > 0)
              for (var i, n, o = new Array(i), s = 0; s < i; ++s)
                o[s] = arguments[s + 2];
            if (!this._.hasOwnProperty(t))
              throw new Error("unknown type: " + t);
            for (s = 0, i = (n = this._[t]).length; s < i; ++s)
              n[s].value.apply(e, o);
          },
          apply: function (t, e, i) {
            if (!this._.hasOwnProperty(t))
              throw new Error("unknown type: " + t);
            for (var n = this._[t], o = 0, s = n.length; o < s; ++o)
              n[o].value.apply(e, i);
          },
        };
        const E = b;
        ...
        function Z(t, e, i, n, o, s) {
          for (var r, a = 0, h = e.length, l = s.length; a < l; ++a)
            (r = e[a])
              ? ((r.__data__ = s[a]), (n[a] = r))
              : (i[a] = new R(t, s[a]));
          for (; a < h; ++a) (r = e[a]) && (o[a] = r);
        }
        function j(t, e, i, n, o, s, r) {
          var a,
            h,
            l,
            u = new Map(),
          ...
          for (a = 0; a < c; ++a)
            (h = e[a]) &&
              ((_[a] = l = r.call(h, h.__data__, a, e) + ""),
              u.has(l) ? (o[a] = h) : u.set(l, h));
          for (a = 0; a < d; ++a)
            (l = r.call(t, s[a], a, s) + ""),
              (h = u.get(l))
                ? ((n[a] = h), (h.__data__ = s[a]), u.delete(l))
                : (i[a] = new R(t, s[a]));
          for (a = 0; a < c; ++a) (h = e[a]) && u.get(_[a]) === h && (o[a] = h);
        }
        function H(t) {
          return t.__data__;
        }
        ...
        function q(t) {
          ...
          return (
            ...
            F.hasOwnProperty(e) ? { space: F[e], local: t } : t
          );
        }
        function V(t) {
          return function () {
        ...
        function ut(t, e) {
          for (var i = ht(t), n = -1, o = e.length; ++n < o; ) i.add(e[n]);
        }
        function ct(t, e) {
          for (var i = ht(t), n = -1, o = e.length; ++n < o; ) i.remove(e[n]);
        }
        function dt(t) {
          return function () {
            ut(this, t);
        ...
        function ft(t, e) {
          return function () {
            (e.apply(this, arguments) ? ut : ct)(this, t);
          };
        }
        function pt() {
          this.textContent = "";
        ...
        function Pt(t) {
          return function () {
            var e = this.ownerDocument,
              i = this.namespaceURI;
            return i === W && e.documentElement.namespaceURI === W
              ? e.createElement(t)
        ...
        function Nt(t) {
          return function () {
            var e = this.__on;
            if (e) {
              for (var i, n = 0, o = -1, s = e.length; n < s; ++n)
                (i = e[n]),
          ...
          return function () {
            ...
            if (o)
              for (var r = 0, a = o.length; r < a; ++r)
                if ((n = o[r]).type === t.type && n.name === t.name)
                  return (
        ...
        function It(t, e, i) {
          ...
          "function" == typeof o
            ...
            : ((o = n.document.createEvent("Event")),
              i
                ? (o.initEvent(e, i.bubbles, i.cancelable),
                  (o.detail = i.detail))
                : o.initEvent(e, !1, !1)),
            t.dispatchEvent(o);
        }
        ...
        function Bt() {
          return new Dt([[document.documentElement]], At);
        }
        Dt.prototype = Bt.prototype = {
          ...
          select: function (t) {
            ...
            for (
              var e = this._groups, i = e.length, n = new Array(i), o = 0;
              o < i;
              ++o
            )
              for (
                ...
                (s = a[u]) &&
                  (r = t.call(s, s.__data__, u, a)) &&
                  ("__data__" in s && (r.__data__ = s.__data__), (l[u] = r));
            return new Dt(n, this._parents);
          },
          selectAll: function (t) {
            t =
              "function" == typeof t
                ...
                : N(t);
            for (
              var e = this._groups, i = e.length, n = [], o = [], s = 0;
              s < i;
              ++s
            )
              for (var r, a = e[s], h = a.length, l = 0; l < h; ++l)
                (r = a[l]) && (n.push(t.call(r, r.__data__, l, a)), o.push(r));
            return new Dt(n, o);
          },
          ...
          filter: function (t) {
            ...
            for (
              ...
              for (
                var s, r = e[o], a = r.length, h = (n[o] = []), l = 0;
                l < a;
                ++l
              )
                (s = r[l]) && t.call(s, s.__data__, l, r) && h.push(s);
            return new Dt(n, this._parents);
          },
          data: function (t, e) {
            ...
            for (
              ...
              var u = n[l],
                c = o[l],
                d = c.length,
                _ = U(t.call(u, u && u.__data__, l, n)),
                f = _.length,
                p = (a[l] = new Array(f)),
                g = (r[l] = new Array(f));
              i(u, c, p, g, (h[l] = new Array(d)), _, e);
              for (var m, v, y = 0, x = 0; y < f; ++y)
                if ((m = p[y])) {
                  for (y >= x && (x = y + 1); !(v = g[x]) && ++x < f; );
                  m._next = v || null;
                }
            }
            return ((r = new Dt(r, n))._enter = a), (r._exit = h), r;
          },
          enter: function () {
            return new Dt(this._enter || this._groups.map(B), this._parents);
          },
          exit: function () {
            return new Dt(this._exit || this._groups.map(B), this._parents);
          },
          join: function (t, e, i) {
            var n = this.enter(),
              o = this,
          ...
          order: function () {
            for (var t = this._groups, e = -1, i = t.length; ++e < i; )
              for (var n, o = t[e], s = o.length - 1, r = o[s]; --s >= 0; )
                (n = o[s]) &&
                  (r &&
                    4 ^ n.compareDocumentPosition(r) &&
          ...
          sort: function (t) {
            ...
            t || (t = G);
            for (
              var i = this._groups, n = i.length, o = new Array(n), s = 0;
              s < n;
              ++s
            ) {
              for (
                var r, a = i[s], h = a.length, l = (o[s] = new Array(h)), u = 0;
                u < h;
                ++u
              )
                (r = a[u]) && (l[u] = r);
          ...
          each: function (t) {
            for (var e = this._groups, i = 0, n = e.length; i < n; ++i)
              for (var o, s = e[i], r = 0, a = s.length; r < a; ++r)
                (o = s[r]) && t.call(o, o.__data__, r, s);
            return this;
          },
          attr: function (t, e) {
            var i = q(t);
            if (arguments.length < 2) {
              var n = this.node();
              return i.local
                ? n.getAttributeNS(i.space, i.local)
                : n.getAttribute(i);
            }
            return this.each(
              (null == e
          ...
          style: function (t, e, i) {
            return arguments.length > 1
              ? this.each(
                  (null == e ? tt : "function" == typeof e ? it : et)(
                    t,
                    e,
                    null == i ? "" : i
                  )
          ...
          property: function (t, e) {
            return arguments.length > 1
              ? this.each(
                  (null == e ? ot : "function" == typeof e ? rt : st)(t, e)
                )
              : this.node()[t];
          },
          classed: function (t, e) {
            var i = at(t + "");
            if (arguments.length < 2) {
              for (var n = ht(this.node()), o = -1, s = i.length; ++o < s; )
                if (!n.contains(i[o])) return !1;
              return !0;
            }
            return this.each(("function" == typeof e ? ft : e ? dt : _t)(i, e));
          },
          text: function (t) {
            return arguments.length
              ? this.each(
                  null == t ? pt : ("function" == typeof t ? mt : gt)(t)
                )
          ...
          html: function (t) {
            return arguments.length
              ? this.each(
                  null == t ? vt : ("function" == typeof t ? xt : yt)(t)
                )
              : this.node().innerHTML;
          },
          raise: function () {
          ...
          insert: function (t, e) {
            var i = "function" == typeof t ? t : Tt(t),
              n = null == e ? Et : "function" == typeof e ? e : M(e);
            return this.select(function () {
          ...
          on: function (t, e, i) {
            var n,
              ...
              r = s.length;
            if (!(arguments.length < 2)) {
              for (a = e ? Ot : Nt, n = 0; n < r; ++n) this.each(a(s[n], e, i));
              return this;
            }
          ...
          dispatch: function (t, e) {
            return this.each(("function" == typeof e ? kt : zt)(t, e));
          },
          [Symbol.iterator]: function* () {
            for (var t = this._groups, e = 0, i = t.length; e < i; ++e)
              for (var n, o = t[e], s = 0, r = o.length; s < r; ++s)
                (n = o[s]) && (yield n);
          },
        };
        const Rt = Bt;
        ...
        function Ft(t) {
          var e = t.document.documentElement,
            i = Zt(t).on("dragstart.drag", Wt, Ut);
          "onselectstart" in e
            ? i.on("selectstart.drag", Wt, Ut)
            : ((e.__noselect = e.style.MozUserSelect),
              (e.style.MozUserSelect = "none"));
        }
        function qt(t, e) {
          var i = t.document.documentElement,
            n = Zt(t).on("dragstart.drag", null);
          e &&
            (n.on("click.drag", Wt, Ut),
            setTimeout(function () {
        ...
        const ee = (function t(e, i, n) {
          function o(t, o) {
            ...
            if (p < 1e-12)
              (r = Math.log(d / l) / e),
                (s = function (t) {
                  return [a + t * _, h + t * f, l * Math.exp(e * t * r)];
                });
            else {
              var g = Math.sqrt(p),
                m = (d * d - l * l + n * p) / (2 * l * i * g),
                v = (d * d - l * l - n * p) / (2 * d * i * g),
              ...
              (r = (x - y) / e),
                (s = function (t) {
                  ...
                  return [a + s * _, h + s * f, (l * o) / te(e * n + y)];
                });
            }
            return (s.duration = (1e3 * r * e) / Math.SQRT2), s;
          }
          return (
            (o.rho = function (e) {
              var i = Math.max(0.001, +e),
                n = i * i;
              return t(i, n, n * n);
            }),
            o
        ...
        function me() {
          (le = (he = ce.now()) + ue), (oe = se = 0);
          try {
            !(function () {
              _e(), ++oe;
              for (var t, e = ie; e; )
                (t = le - e._time) >= 0 && e._call.call(void 0, t),
                  (e = e._next);
              --oe;
            })();
          } finally {
        ...
        function ye(t) {
          oe ||
            ...
            t - le > 24
              ? (t < 1 / 0 && (se = setTimeout(me, t - ce.now() - ue)),
                re && (re = clearInterval(re)))
              : (re || ((he = ce.now()), (re = setInterval(ve, ae))),
                (oe = 1),
                de(me)));
        }
        function xe(t, e, i) {
        ...
        pe.prototype = ge.prototype = {
          ...
          restart: function (t, e, i) {
            ...
            (i = (null == i ? _e() : +i) + (null == e ? 0 : +e)),
              this._next ||
                ne === this ||
                (ne ? (ne._next = this) : (ie = this), (ne = this)),
              (this._call = t),
              (this._time = i),
              ye();
          },
        ...
        var we = E("start", "end", "cancel", "interrupt"),
          be = [],
          Pe = 0,
          Se = 3;
        function Te(t, e, i, n, o, s) {
          ...
          !(function (t, e, i) {
            ...
            function s(h) {
              var l, u, c, d;
              if (1 !== i.state) return a();
              for (l in o)
                if ((d = o[l]).name === i.name) {
                  if (d.state === Se) return xe(s);
                  4 === d.state
                    ? ((d.state = 6),
                      d.timer.stop(),
              ...
              if (
                (xe(function () {
                  i.state === Se &&
                    ((i.state = 4), i.timer.restart(r, i.delay, i.time), r(h));
                }),
                (i.state = 2),
                ...
                for (
                  i.state = Se,
                    n = new Array((c = i.tween.length)),
                    l = 0,
                    u = -1;
                  l < c;
                  ++l
                )
                  (d = i.tween[l].value.call(
                    t,
                    t.__data__,
                    i.index,
                    i.group
            ...
            function r(e) {
              for (
                ...
                n[s].call(t, o);
              5 === i.state &&
                (i.on.call("end", t, t.__data__, i.index, i.group), a());
            }
            function a() {
        ...
        function Ee(t, e) {
          var i = Me(t, e);
          if (i.state > Pe) throw new Error("too late; already scheduled");
          return i;
        }
        function Le(t, e) {
          var i = Me(t, e);
          if (i.state > Se) throw new Error("too late; already running");
          return i;
        }
        function Me(t, e) {
        ...
        function ke(t, e, i, n, o, s) {
          var r, a, h;
          return (
            (r = Math.sqrt(t * t + e * e)) && ((t /= r), (e /= r)),
            (h = t * i + e * n) && ((i -= t * h), (n -= e * h)),
            (a = Math.sqrt(i * i + n * n)) && ((i /= a), (n /= a), (h /= a)),
            t * n < e * i && ((t = -t), (e = -e), (h = -h), (r = -r)),
            {
              translateX: o,
              translateY: s,
              rotate: Math.atan2(e, t) * Ie,
              skewX: Math.atan(h) * Ie,
              scaleX: r,
              scaleY: a,
            }
          );
        ...
        function Ae(t, e, i, n) {
          ...
          return function (s, r) {
            ...
            return (
              (s = t(s)),
              (r = t(r)),
              (function (t, n, o, s, r, a) {
                if (t !== o || n !== s) {
                  var h = r.push("translate(", null, e, null, i);
                  a.push({ i: h - 4, x: Ne(t, o) }, { i: h - 2, x: Ne(n, s) });
                } else (o || s) && r.push("translate(" + o + e + s + i);
              })(s.translateX, s.translateY, r.translateX, r.translateY, a, h),
              (function (t, e, i, s) {
                t !== e
                  ? (t - e > 180 ? (e += 360) : e - t > 180 && (t += 360),
                    s.push({
                      i: i.push(o(i) + "rotate(", null, n) - 2,
                      x: Ne(t, e),
                    }))
                  : e && i.push(o(i) + "rotate(" + e + n);
              })(s.rotate, r.rotate, a, h),
              (function (t, e, i, s) {
                t !== e
                  ? s.push({
                      i: i.push(o(i) + "skewX(", null, n) - 2,
                      x: Ne(t, e),
                    })
                  : e && i.push(o(i) + "skewX(" + e + n);
              })(s.skewX, r.skewX, a, h),
              (function (t, e, i, n, s, r) {
                if (t !== i || e !== n) {
                  var a = s.push(o(s) + "scale(", null, ",", null, ")");
                  r.push({ i: a - 4, x: Ne(t, i) }, { i: a - 2, x: Ne(e, n) });
                } else
                  (1 === i && 1 === n) ||
                    s.push(o(s) + "scale(" + i + "," + n + ")");
              })(s.scaleX, s.scaleY, r.scaleX, r.scaleY, a, h),
              (s = r = null),
              function (t) {
                for (var e, i = -1, n = h.length; ++i < n; )
                  a[(e = h[i]).i] = e.x(t);
                return a.join("");
              }
            );
        ...
        var De = Ae(
            function (t) {
              ...
              return e.isIdentity ? ze : ke(e.a, e.b, e.c, e.d, e.e, e.f);
            },
            "px, ",
            "px)",
            "deg)"
              ...
              return null == t
                ...
                : (Oe ||
                  ...
                  (t = Oe.transform.baseVal.consolidate())
                    ? ke((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f)
                    : ze);
            },
            ", ",
            ")",
        ...
        function Re(t, e) {
          ...
          return function () {
            var o = Le(this, t),
              s = o.tween;
            if (s !== i)
              for (var r = 0, a = (n = i = s).length; r < a; ++r)
                if (n[r].name === e) {
                  (n = n.slice()).splice(r, 1);
                  break;
                }
            o.tween = n;
          };
        ...
        function Ze(t, e, i) {
          ...
          return function () {
            ...
            if (r !== n) {
              o = (n = r).slice();
              for (
                var a = { name: e, value: i }, h = 0, l = o.length;
                h < l;
                ++h
              )
                if (o[h].name === e) {
        ...
        var We = 0.7,
          ...
          Ke = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",
          Ye = /^#([0-9a-f]{3,8})$/,
          Xe = new RegExp(`^rgb\\(${qe},${qe},${qe}\\)$`),
          $e = new RegExp(`^rgb\\(${Ke},${Ke},${Ke}\\)$`),
          Je = new RegExp(`^rgba\\(${qe},${qe},${qe},${Ve}\\)$`),
          Qe = new RegExp(`^rgba\\(${Ke},${Ke},${Ke},${Ve}\\)$`),
          ti = new RegExp(`^hsl\\(${Ve},${Ke},${Ke}\\)$`),
          ei = new RegExp(`^hsla\\(${Ve},${Ke},${Ke},${Ve}\\)$`),
          ii = {
            aliceblue: 15792383,
        ...
        function si(t) {
          ...
          return (
            ...
            (e = Ye.exec(t))
              ...
              : (e = ti.exec(t))
              ? pi(e[1], e[2] / 100, e[3] / 100, 1)
              : (e = ei.exec(t))
              ? pi(e[1], e[2] / 100, e[3] / 100, e[4])
              : ii.hasOwnProperty(t)
              ? ri(ii[t])
              : "transparent" === t
              ? new li(NaN, NaN, NaN, 0)
              : null
          );
        }
        function ri(t) {
          return new li((t >> 16) & 255, (t >> 8) & 255, 255 & t, 1);
        }
        function ai(t, e, i, n) {
          return n <= 0 && (t = e = i = NaN), new li(t, e, i, n);
        }
        function hi(t, e, i, n) {
          return 1 === arguments.length
            ? ((o = t) instanceof Ge || (o = si(o)),
              o ? new li((o = o.rgb()).r, o.g, o.b, o.opacity) : new li())
            : new li(t, e, i, null == n ? 1 : n);
          var o;
        }
        function li(t, e, i, n) {
        ...
        function ci() {
          const t = di(this.opacity);
          return `${1 === t ? "rgb(" : "rgba("}${_i(this.r)}, ${_i(
            this.g
          )}, ${_i(this.b)}${1 === t ? ")" : `, ${t})`}`;
        }
        function di(t) {
        ...
        function fi(t) {
          return ((t = _i(t)) < 16 ? "0" : "") + t.toString(16);
        }
        function pi(t, e, i, n) {
          return (
            n <= 0
        ...
        function gi(t) {
          if (t instanceof mi) return new mi(t.h, t.s, t.l, t.opacity);
          if ((t instanceof Ge || (t = si(t)), !t)) return new mi();
        ...
        He(Ge, si, {
            ...
            Ue(Ge, {
              brighter(t) {
                return (
                  ...
                  new li(this.r * t, this.g * t, this.b * t, this.opacity)
                );
              },
              darker(t) {
                return (
                  (t = null == t ? We : Math.pow(We, t)),
                  new li(this.r * t, this.g * t, this.b * t, this.opacity)
                );
              },
              rgb() {
              ...
              formatHex: ui,
              formatHex8: function () {
                return `#${fi(this.r)}${fi(this.g)}${fi(this.b)}${fi(
          ...
          He(
            ...
            function (t, e, i, n) {
              return 1 === arguments.length
                ? gi(t)
                : new mi(t, e, i, null == n ? 1 : n);
            },
            Ue(Ge, {
              brighter(t) {
                return (
                  (t = null == t ? Fe : Math.pow(Fe, t)),
                  new mi(this.h, this.s, this.l * t, this.opacity)
                );
              },
              darker(t) {
                return (
              ...
              rgb() {
                var t = (this.h % 360) + 360 * (this.h < 0),
                  ...
                  o = 2 * i - n;
                return new li(
                  xi(t >= 240 ? t - 240 : t + 120, o, n),
                  xi(t, o, n),
                  xi(t < 120 ? t + 240 : t - 120, o, n),
                  this.opacity
                );
              },
              clamp() {
        ...
        const Si = (function t(e) {
          ...
          function n(t, e) {
            var n = i((t = hi(t)).r, (e = hi(e)).r),
              o = i(t.g, e.g),
              s = i(t.b, e.b),
              r = Pi(t.opacity, e.opacity);
            return function (e) {
              return (
                (t.r = n(e)),
                (t.g = o(e)),
        ...
        function Ti(t) {
          return function (e) {
            ...
            return (
              ...
              (n.opacity = 1),
              function (t) {
                return (n.r = s(t)), (n.g = r(t)), (n.b = a(t)), n + "";
              }
            );
          };
        }
          ...
          Ti(function (t) {
            ...
            return function (i) {
              var n = Math.floor(((i %= 1) < 0 ? ++i : i) * e),
                ...
                r = t[(n + 1) % e],
                a = t[(n + 2) % e];
              return wi((i - n / e) * e, o, s, r, a);
            };
          });
        var Ei = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
          Li = new RegExp(Ei.source, "g");
        function Mi(t, e) {
          var i,
            n,
            o,
            s = (Ei.lastIndex = Li.lastIndex = 0),
            r = -1,
            a = [],
            h = [];
          for (t += "", e += ""; (i = Ei.exec(t)) && (n = Li.exec(e)); )
            (o = n.index) > s &&
              ((o = e.slice(s, o)), a[r] ? (a[r] += o) : (a[++r] = o)),
              (i = i[0]) === (n = n[0])
                ? a[r]
                  ? (a[r] += n)
                  : (a[++r] = n)
                : ((a[++r] = null), h.push({ i: r, x: Ne(i, n) })),
              (s = Li.lastIndex);
          return (
            s < e.length &&
              ((o = e.slice(s)), a[r] ? (a[r] += o) : (a[++r] = o)),
            a.length < 2
              ? h[0]
                ? (function (t) {
                    return function (e) {
              ...
              : ((e = h.length),
                function (t) {
                  for (var i, n = 0; n < e; ++n) a[(i = h[n]).i] = i.x(t);
                  return a.join("");
                })
          );
        }
        ...
        function Ii(t, e, i) {
          ...
          return function () {
            ...
            return r === s ? null : r === n ? o : (o = e((n = r), i));
          };
        }
        function zi(t, e, i) {
          var n,
        ...
        function ki(t, e, i) {
          ...
          return function () {
            var r,
              ...
              h = i(this);
            if (null != h)
              return (r = this.getAttribute(t)) === (a = h + "")
                ? null
                : r === n && a === o
                ? s
                : ((o = a), (s = e((n = r), h)));
        ...
        var Ui = Rt.prototype.constructor;
        function Gi(t) {
          return function () {
            this.style.removeProperty(t);
          };
        ...
        Fi.prototype = function (t) {
          ...
          select: function (t) {
            ...
            "function" != typeof t && (t = M(t));
            for (
              var n = this._groups, o = n.length, s = new Array(o), r = 0;
              r < o;
              ++r
            )
              for (
                ...
                (a = l[d]) &&
                  (h = t.call(a, a.__data__, d, l)) &&
                  ("__data__" in a && (h.__data__ = a.__data__),
                  (c[d] = h),
                  Te(c[d], e, i, d, c, Me(a, i)));
            return new Fi(s, this._parents, e, i);
          },
          selectAll: function (t) {
            var e = this._name,
              i = this._id;
            ...
            for (
              var n = this._groups, o = n.length, s = [], r = [], a = 0;
              a < o;
              ++a
            )
              for (var h, l = n[a], u = l.length, c = 0; c < u; ++c)
                if ((h = l[c])) {
                  for (
                    var d,
                      _ = t.call(h, h.__data__, c, l),
                      f = Me(h, i),
                      p = 0,
                      g = _.length;
                    p < g;
                    ...
                    (d = _[p]) && Te(d, e, i, p, _, f);
                  s.push(_), r.push(h);
                }
            return new Fi(s, r, e, i);
          },
          selectChild: Vi.selectChild,
          selectChildren: Vi.selectChildren,
          filter: function (t) {
            "function" != typeof t && (t = O(t));
            for (
              var e = this._groups, i = e.length, n = new Array(i), o = 0;
          ...
          transition: function () {
            for (
              ...
              for (var r, a = n[s], h = a.length, l = 0; l < h; ++l)
                if ((r = a[l])) {
                  var u = Me(r, e);
                  Te(r, t, i, l, a, {
            ...
            return new Fi(n, this._parents, t, i);
          },
          call: Vi.call,
          nodes: Vi.nodes,
          node: Vi.node,
          ...
          attr: function (t, e) {
            ...
            return this.attrTween(
              t,
              "function" == typeof e
                ? (i.local ? Ai : ki)(i, n, je(this, "attr." + t, e))
                : null == e
                ? (i.local ? Oi : Ni)(i)
                : (i.local ? zi : Ii)(i, n, e)
            );
          ...
          attrTween: function (t, e) {
            ...
            var n = q(t);
            return this.tween(i, (n.local ? Di : Bi)(n, e));
          },
          style: function (t, e, i) {
            var n = "transform" == (t += "") ? De : Ci;
            return null == e
              ? this.styleTween(
                  t,
                  (function (t, e) {
                    ...
                    return function () {
                      var s = nt(this, t),
                        r = (this.style.removeProperty(t), nt(this, t));
                      return s === r
                        ? null
                        : s === i && r === n
                        ? o
              ...
              ? this.styleTween(
                  ...
                  (function (t, e, i) {
                    ...
                    return function () {
                      ...
                      return (
                        null == a &&
                          (this.style.removeProperty(t), (h = a = nt(this, t))),
                        r === h
                          ? null
                          : r === n && h === o
                          ? s
                  ...
                  (function (t, e) {
                    ...
                    return function () {
                      var h = Le(this, t),
                        l = h.on,
                        u = null == h.value[r] ? s || (s = Gi(e)) : void 0;
                      (l === i && o === u) ||
                        (n = (i = l).copy()).on(a, (o = u)),
                        (h.on = n);
                    };
          ...
          tween: function (t, e) {
            ...
            if (((t += ""), arguments.length < 2)) {
              for (
                var n, o = Me(this.node(), i).tween, s = 0, r = o.length;
                s < r;
                ++s
              )
                if ((n = o[s]).name === t) return n.value;
              return null;
            }
            return this.each((null == e ? Re : Ze)(i, t, e));
          },
          delay: function (t) {
            var e = this._id;
            return arguments.length
              ? this.each(("function" == typeof t ? Ri : Zi)(e, t))
              : Me(this.node(), e).delay;
          },
          duration: function (t) {
            var e = this._id;
            return arguments.length
              ? this.each(("function" == typeof t ? ji : Hi)(e, t))
              : Me(this.node(), e).duration;
          },
          ease: function (t) {
            var e = this._id;
            return arguments.length
        ...
        (Rt.prototype.interrupt = function (t) {
          ...
          (Rt.prototype.transition = function (t) {
            ...
            for (var n = this._groups, o = n.length, s = 0; s < o; ++s)
              for (var r, a = n[s], h = a.length, l = 0; l < h; ++l)
                (r = a[l]) && Te(r, t, e, l, a, i || Yi(r, e));
            return new Fi(n, this._parents, t, e);
          });
        const Xi = (t) => () => t;
        function $i(
          t,
          { sourceEvent: e, target: i, transform: n, dispatch: o }
        ) {
          Object.defineProperties(this, {
            type: { value: t, enumerable: !0, configurable: !0 },
            sourceEvent: { value: e, enumerable: !0, configurable: !0 },
        ...
        Ji.prototype = {
          constructor: Ji,
          scale: function (t) {
            return 1 === t ? this : new Ji(this.k * t, this.x, this.y);
          },
          translate: function (t, e) {
            return (0 === t) & (0 === e)
              ? this
              : new Ji(this.k, this.x + this.k * t, this.y + this.k * e);
          },
          apply: function (t) {
        ...
        function hn(t, e, i) {
          var n = t.invertX(e[0][0]) - i[0][0],
            o = t.invertX(e[1][0]) - i[1][0],
            s = t.invertY(e[0][1]) - i[0][1],
            r = t.invertY(e[1][1]) - i[1][1];
          return t.translate(
        ...
        Ji.prototype;
        const ln = (t, e) => !!t && !!e && t.x === e.x && t.y === e.y;
        var un;
        !(function (t) {
          (t.SIMULATION_START = "simulation-start"),
            (t.SIMULATION_PROGRESS = "simulation-progress"),
            (t.SIMULATION_END = "simulation-end"),
            (t.NODE_DRAG = "node-drag"),
            (t.NODE_DRAG_END = "node-drag-end"),
            (t.SETTINGS_UPDATE = "settings-update");
        })(un || (un = {}));
        class cn {
          constructor() {
          ...
          once(t, e) {
            const i = { callable: e, isOnce: !0 },
              n = this._listeners.get(t);
            return n ? n.push(i) : this._listeners.set(t, [i]), this;
          }
          on(t, e) {
            const i = { callable: e },
              n = this._listeners.get(t);
          ...
          off(t, e) {
            ...
            if (i) {
              const n = i.filter((t) => t.callable !== e);
          ...
          emit(t, e) {
            ...
            for (let t = 0; t < i.length; t++)
              i[t].isOnce && (n = !0), i[t].callable(e);
            if (n) {
              const e = i.filter((t) => !t.isOnce);
          ...
          removeAllListeners(t) {
            return (
              t ? this._listeners.delete(t) : this._listeners.clear(), this
            );
          }
        }
        function dn(t) {
        ...
        function xn(t, e, i, n) {
          ...
          for (; _.length; )
            if (
              ...
              return (o[c] = f), t;
          if (
            ((a = +t._x.call(null, _.data)),
            (h = +t._y.call(null, _.data)),
            e === a && i === h)
          )
            return (f.next = _), o ? (o[c] = f) : (t._root = f), t;
          do {
            (o = o ? (o[c] = new Array(4)) : (t._root = new Array(4))),
              (l = e >= (s = (p + m) / 2)) ? (p = s) : (m = s),
              (u = i >= (r = (g + v) / 2)) ? (g = r) : (v = r);
          } while ((c = (u << 1) | l) == (d = ((h >= r) << 1) | (a >= s)));
          return (o[d] = _), (o[c] = f), t;
        }
        ...
        var Ln = (Sn.prototype = Tn.prototype);
        function Mn(t) {
          return t.x + t.vx;
        }
        function Cn(t) {
        ...
        (Ln.copy = function () {
          var t,
            ...
            n = this._root;
          if (!n) return i;
          if (!n.length) return (i._root = En(n)), i;
          for (
            t = [{ source: n, target: (i._root = new Array(4)) }];
            (n = t.pop());
            ...
            for (var o = 0; o < 4; ++o)
              (e = n.source[o]) &&
                (e.length
                  ? t.push({ source: e, target: (n.target[o] = new Array(4)) })
                  : (n.target[o] = En(e)));
          return i;
        }),
          (Ln.add = function (t) {
            ...
            return xn(this.cover(e, i), e, i, t);
          }),
          (Ln.addAll = function (t) {
            var e,
              i,
              n,
              o,
              ...
              c = -1 / 0;
            for (i = 0; i < s; ++i)
              isNaN((n = +this._x.call(null, (e = t[i])))) ||
                ...
                o < l && (l = o),
                o > c && (c = o));
            if (h > u || l > c) return this;
            for (this.cover(h, l).cover(u, c), i = 0; i < s; ++i)
              xn(this, r[i], a[i], t[i]);
            return this;
          }),
          (Ln.cover = function (t, e) {
            ...
            var i = this._x0,
              ...
              s = this._y1;
            if (isNaN(i))
              (o = (i = Math.floor(t)) + 1), (s = (n = Math.floor(e)) + 1);
            else {
              for (
                var r, a, h = o - i || 1, l = this._root;
                i > t || t >= o || n > e || e >= s;
            ...
            if (_.length)
              for (;;) {
                if (
                  ...
                  return this;
                if (!_.length) break;
                (e[(c + 1) & 3] || e[(c + 2) & 3] || e[(c + 3) & 3]) &&
                  ((i = e), (d = c));
              }
            for (; _.data !== t; ) if (((n = _), !(_ = _.next))) return this;
            return (
              (o = _.next) && delete _.next,
              n
                ...
                ? (o ? (e[c] = o) : delete e[c],
                  (_ = e[0] || e[1] || e[2] || e[3]) &&
                    _ === (e[3] || e[2] || e[1] || e[0]) &&
                    !_.length &&
                    (i ? (i[d] = _) : (this._root = _)),
                  this)
                : ((this._root = o), this)
            );
          }),
          (Ln.removeAll = function (t) {
          ...
          (Ln.visit = function (t) {
            var e,
              ...
              h = this._root;
            for (
              h && a.push(new wn(h, this._x0, this._y0, this._x1, this._y1));
              (e = a.pop());
              ...
              if (
                ...
                var l = (n + s) / 2,
                  u = (o + r) / 2;
                (i = h[3]) && a.push(new wn(i, l, u, s, r)),
                  (i = h[2]) && a.push(new wn(i, n, u, l, r)),
                  (i = h[1]) && a.push(new wn(i, l, o, s, u)),
                  (i = h[0]) && a.push(new wn(i, n, o, l, u));
              }
            return this;
          }),
          (Ln.visitAfter = function (t) {
            var e,
              i = [],
              n = [];
            for (
              this._root &&
              i.push(
                new wn(this._root, this._x0, this._y0, this._x1, this._y1)
              );
              (e = i.pop());
              ...
              if (o.length) {
                var s,
                  ...
                  u = (r + h) / 2,
                  c = (a + l) / 2;
                (s = o[0]) && i.push(new wn(s, r, a, u, c)),
                  (s = o[1]) && i.push(new wn(s, u, a, h, c)),
                  (s = o[2]) && i.push(new wn(s, r, c, u, l)),
                  (s = o[3]) && i.push(new wn(s, u, c, h, l));
              }
              n.push(e);
            }
            for (; (e = n.pop()); ) t(e.node, e.x0, e.y0, e.x1, e.y1);
            return this;
          }),
          (Ln.x = function (t) {
        ...
        const Nn = (t) => t instanceof Date,
          On = (t) => Array.isArray(t),
          In = (t) =>
            null !== t &&
            "object" == typeof t &&
            "Object" === t.constructor.name,
          zn = (t) => (Nn(t) ? An(t) : On(t) ? Dn(t) : In(t) ? Bn(t) : t),
          kn = (t, e) => {
            const i = Nn(t),
              n = Nn(e);
            if ((i && !n) || (!i && n)) return !1;
            if (i && n) return t.getTime() === e.getTime();
            const o = On(t),
              s = On(e);
            if ((o && !s) || (!o && s)) return !1;
            if (o && s)
              return t.length === e.length && t.every((t, i) => kn(t, e[i]));
            const r = In(t),
              a = In(e);
            if ((r && !a) || (!r && a)) return !1;
            if (r && a) {
              const i = Object.keys(t),
                n = Object.keys(e);
              return !!kn(i, n) && i.every((i) => kn(t[i], e[i]));
            }
            return t === e;
          },
          An = (t) => new Date(t),
        ...
        const Zn = {
          ...
          links: { distance: 30, strength: void 0, iterations: 1 },
          manyBody: {
            strength: -100,
            theta: 0.9,
            distanceMin: 0,
          ...
          positioning: {
            forceX: { x: 0, strength: 0.1 },
            forceY: { y: 0, strength: 0.1 },
          },
        };
        class jn extends cn {
          constructor(t) {
            super(),
              ...
              (this._isDragging = !1),
              (this._isStabilizing = !1),
              (this.linkForce = (function (t) {
                var e,
                  i,
                  n,
                  o,
                  ...
                  u = 1;
                function c(n) {
                  for (var o = 0, a = t.length; o < u; ++o)
                    for (var h, l, c, d, _, f, p, g = 0; g < a; ++g)
                      (l = (h = t[g]).source),
                        (d = (c = h.target).x + c.vx - l.x - l.vx || _n(r)),
                        (_ = c.y + c.vy - l.y - l.vy || _n(r)),
                        (d *= f =
                          (((f = Math.sqrt(d * d + _ * _)) - i[g]) / f) *
                          n *
                          e[g]),
                        (_ *= f),
                        (c.vx -= d * (p = s[g])),
                ...
                function d() {
                  if (n) {
                    var r,
                      ...
                      l = n.length,
                      u = t.length,
                      c = new Map(n.map((t, e) => [a(t, e, n), t]));
                    for (r = 0, o = new Array(l); r < u; ++r)
                      ((h = t[r]).index = r),
                        "object" != typeof h.source &&
                          (h.source = pn(c, h.source)),
                        "object" != typeof h.target &&
                          (h.target = pn(c, h.target)),
                        (o[h.source.index] = (o[h.source.index] || 0) + 1),
                        (o[h.target.index] = (o[h.target.index] || 0) + 1);
                    for (r = 0, s = new Array(u); r < u; ++r)
                      (h = t[r]),
                        (s[r] =
                          o[h.source.index] /
                          (o[h.source.index] + o[h.target.index]));
                    (e = new Array(u)), _(), (i = new Array(u)), f();
                  }
                }
                function _() {
                  if (n)
                ...
                return (
                  ...
                  (c.strength = function (t) {
                    return arguments.length
                      ? ((h = "function" == typeof t ? t : dn(+t)), _(), c)
                      : h;
                  }),
                  (c.distance = function (t) {
                    return arguments.length
                      ? ((l = "function" == typeof t ? t : dn(+t)), f(), c)
                      : l;
                  }),
                  c
                );
              })(this._edges).id((t) => t.id)),
              (this.simulation = (function (t) {
                var e,
                  i = 1,
                  n = 0.001,
                  o = 1 - Math.pow(n, 1 / 300),
                  s = 0,
                  r = 0.6,
                  a = new Map(),
                  h = ge(c),
                  ...
                  u = (function () {
                    let t = 1;
                    return () => (t = (1664525 * t + 1013904223) % gn) / gn;
                  })();
                function c() {
                  d(), l.call("tick", e), i < n && (h.stop(), l.call("end", e));
                }
                function d(n) {
                  var h,
                    l,
                ...
                function _() {
                  for (var e, i = 0, n = t.length; i < n; ++i) {
                    if (
                      ...
                      var o = 10 * Math.sqrt(0.5 + i),
                        s = i * yn;
                      (e.x = o * Math.cos(s)), (e.y = o * Math.sin(s));
                    }
                ...
                return (
                  ...
                  (e = {
                    ...
                    velocityDecay: function (t) {
                      return arguments.length ? ((r = 1 - t), e) : 1 - r;
                    },
                    ...
                    force: function (t, i) {
                      return arguments.length > 1
                        ? (null == i ? a.delete(t) : a.set(t, f(i)), e)
                        : a.get(t);
                    },
                    find: function (e, i, n) {
                      var o,
                        ...
                        u = t.length;
                      for (
                        null == n ? (n = 1 / 0) : (n *= n), l = 0;
                        l < u;
                        ++l
                      )
                        (r = (o = e - (a = t[l]).x) * o + (s = i - a.y) * s) <
                          n && ((h = a), (n = r));
                      return h;
                    },
                    on: function (t, i) {
                      return arguments.length > 1 ? (l.on(t, i), e) : l.on(t);
                    },
                  })
                );
              })(this._nodes)
                ...
                .stop()),
              (this.settings = Object.assign(zn(Zn), t)),
              this.initSimulation(this.settings),
              this.simulation.on("tick", () => {
                this.emit(Rn.TICK, { nodes: this._nodes, edges: this._edges });
              }),
              this.simulation.on("end", () => {
                (this._isDragging = !1),
                  (this._isStabilizing = !1),
                  this.emit(Rn.END, { nodes: this._nodes, edges: this._edges });
              });
          }
          getSettings() {
            return zn(this.settings);
          }
          setSettings(t) {
            ...
            Object.keys(t).forEach((e) => {
              ...
              kn(this.settings, e) ||
                (this.initSimulation(t),
                this.emit(Rn.SETTINGS_UPDATE, { settings: this.settings }),
                this.runSimulation({ isUpdatingSettings: !0 }));
          }
          startDragNode() {
            (this._isDragging = !0),
              !this._isStabilizing &&
                this.settings.isPhysicsEnabled &&
                this.activateSimulation();
          }
          dragNode(t) {
            const e = this._nodes[this._nodeIndexByNodeId[t.id]];
            e &&
              (this._isDragging || this.startDragNode(),
              (e.fx = t.x),
              (e.fy = t.y),
              this.settings.isPhysicsEnabled ||
                ((e.x = t.x),
                (e.y = t.y),
                this.emit(Rn.NODE_DRAG, {
                  nodes: this._nodes,
                  edges: this._edges,
                })));
          }
          endDragNode(t) {
            (this._isDragging = !1), this.simulation.alphaTarget(0);
            const e = this._nodes[this._nodeIndexByNodeId[t.id]];
            e && this.settings.isPhysicsEnabled && Un(e);
          }
          activateSimulation() {
            this.settings.isPhysicsEnabled &&
              (this.simulation
                .alphaTarget(this.settings.alpha.alphaTarget)
                .restart(),
              this.releaseNodes());
          }
          fixDefinedNodes(t) {
            for (let e = 0; e < t.nodes.length; e++)
              null !== t.nodes[e].x &&
                void 0 !== t.nodes[e].x &&
                (t.nodes[e].fx = t.nodes[e].x),
                null !== t.nodes[e].y &&
                  void 0 !== t.nodes[e].y &&
                  (t.nodes[e].fy = t.nodes[e].y);
            return t;
          }
          addData(t) {
            (t = this.fixDefinedNodes(t)),
              this._nodes.concat(t.nodes),
              this._edges.concat(t.edges),
              this.setNodeIndexByNodeId();
          }
          clearData() {
            (this._nodes = []), (this._edges = []), this.setNodeIndexByNodeId();
          }
          setData(t) {
            (t = this.fixDefinedNodes(t)), this.clearData(), this.addData(t);
          }
          updateData(t) {
            t = this.fixDefinedNodes(t);
            const e = new Set(t.nodes.map((t) => t.id)),
              i = this._nodes.filter((t) => e.has(t.id)),
              n = t.nodes.filter(
                (t) => void 0 === this._nodeIndexByNodeId[t.id]
              );
            (this._nodes = [...i, ...n]),
              this.setNodeIndexByNodeId(),
              (this._edges = t.edges),
          ...
          simulate() {
            this.simulation.nodes(this._nodes),
              this.linkForce.links(this._edges),
              this.runSimulation(),
              this.settings.isPhysicsEnabled || this.fixNodes();
          }
          startSimulation(t) {
            this.setData(t),
              this.simulation.nodes(this._nodes),
          ...
          updateSimulation(t) {
            ...
            this.settings.isPhysicsEnabled || n.forEach((t) => Hn(t)),
              (this._nodes = [...n, ...i]),
              this.setNodeIndexByNodeId(),
              (this._edges = t.edges),
              this.simulation.nodes(this._nodes),
              this.linkForce.links(this._edges),
              this.settings.isPhysicsEnabled || i.length
                ? this.runSimulation({ isUpdatingSettings: !0 })
                : this.emit(Rn.SIMULATION_END, {
                    nodes: this._nodes,
                    edges: this._edges,
                  });
          }
          ...
          initSimulation(t) {
            ...
            if (
              (t.alpha &&
                this.simulation
                  .alpha(t.alpha.alpha)
                  .alphaMin(t.alpha.alphaMin)
                  .alphaDecay(t.alpha.alphaDecay)
                  .alphaTarget(t.alpha.alphaTarget),
              t.links &&
                this.linkForce
                  .distance(t.links.distance)
                  .iterations(t.links.iterations),
              t.collision)
            ) {
              const e = (function (t) {
                var e,
                  ...
                  s = 1;
                function r() {
                  for (var t, r, h, l, u, c, d, _ = e.length, f = 0; f < s; ++f)
                    for (r = Sn(e, Mn, Cn).visitAfter(a), t = 0; t < _; ++t)
                      (h = e[t]),
                        (c = i[h.index]),
                        (d = c * c),
                        (l = h.x + h.vx),
                  ...
                  function p(t, e, i, s, r) {
                    var a = t.data,
                      ...
                      f = c + _;
                    if (!a)
                      return e > l + f || s < l - f || i > u + f || r < u - f;
                    if (a.index > h.index) {
                      var p = l - a.x - a.vx,
                        g = u - a.y - a.vy,
                        m = p * p + g * g;
                ...
                function h() {
                  if (e) {
                    var n,
                      o,
                      s = e.length;
                    for (i = new Array(s), n = 0; n < s; ++n)
                      (o = e[n]), (i[o.index] = +t(o, n, e));
                  }
                }
                return (
                  "function" != typeof t && (t = dn(null == t ? 1 : +t)),
                  (r.initialize = function (t, i) {
                    (e = t), (n = i), h();
                  }),
                  ...
                  (r.radius = function (e) {
                    return arguments.length
                      ? ((t = "function" == typeof e ? e : dn(+e)), h(), r)
                      : t;
                  }),
                  r
                );
              })()
                .radius(t.collision.radius)
                .strength(t.collision.strength)
                .iterations(t.collision.iterations);
              this.simulation.force("collide", e);
            }
            if (
              (null === t.collision && this.simulation.force("collide", null),
              t.manyBody)
            ) {
              const e = (function () {
                var t,
                ...
                function l(i) {
                  var o,
                    s = t.length,
                    r = Sn(t, mn, vn).visitAfter(c);
                  for (n = i, o = 0; o < s; ++o) (e = t[o]), r.visit(d);
                }
                function u() {
                  if (t) {
                    var e,
                      i,
                      n = t.length;
                    for (o = new Array(n), e = 0; e < n; ++e)
                      (i = t[e]), (o[i.index] = +s(i, e, t));
                  }
                }
                function c(t) {
                  var e,
                ...
                return (
                  (l.initialize = function (e, n) {
                    (t = e), (i = n), u();
                  }),
                  (l.strength = function (t) {
                    return arguments.length
                      ? ((s = "function" == typeof t ? t : dn(+t)), u(), l)
                      : s;
                  }),
                  (l.distanceMin = function (t) {
                    return arguments.length ? ((r = t * t), l) : Math.sqrt(r);
                  }),
                  (l.distanceMax = function (t) {
                    return arguments.length ? ((a = t * t), l) : Math.sqrt(a);
                  }),
                  (l.theta = function (t) {
                    return arguments.length ? ((h = t * t), l) : Math.sqrt(h);
                  }),
                  l
                );
              })()
                .strength(t.manyBody.strength)
                .theta(t.manyBody.theta)
                .distanceMin(t.manyBody.distanceMin)
                .distanceMax(t.manyBody.distanceMax);
              this.simulation.force("charge", e);
            }
            if (
              (null === t.manyBody && this.simulation.force("charge", null),
              null === (e = t.positioning) || void 0 === e ? void 0 : e.forceY)
            ) {
              const e = (function (t) {
                var e,
                  i,
                ...
                function s(t) {
                  for (var o, s = 0, r = e.length; s < r; ++s)
                    (o = e[s]).vx += (n[s] - o.x) * i[s] * t;
                }
                function r() {
                  if (e) {
                    var s,
                      r = e.length;
                    for (i = new Array(r), n = new Array(r), s = 0; s < r; ++s)
                      i[s] = isNaN((n[s] = +t(e[s], s, e)))
                        ? 0
                        : +o(e[s], s, e);
                  }
                }
                return (
                  "function" != typeof t && (t = dn(null == t ? 0 : +t)),
                  (s.initialize = function (t) {
                    (e = t), r();
                  }),
                  (s.strength = function (t) {
                    return arguments.length
                      ? ((o = "function" == typeof t ? t : dn(+t)), r(), s)
                      : o;
                  }),
                  (s.x = function (e) {
                    return arguments.length
                      ? ((t = "function" == typeof e ? e : dn(+e)), r(), s)
                      : t;
                  }),
                  s
                );
              })(t.positioning.forceX.x).strength(
                t.positioning.forceX.strength
              );
              this.simulation.force("x", e);
            }
            if (
              (null ===
                (null === (i = t.positioning) || void 0 === i
                  ? void 0
                  : i.forceX) && this.simulation.force("x", null),
              null === (n = t.positioning) || void 0 === n ? void 0 : n.forceY)
            ) {
              const e = (function (t) {
                var e,
                  i,
              ...
              })(t.positioning.forceY.y).strength(
                t.positioning.forceY.strength
              );
              this.simulation.force("y", e);
            }
            if (
              (null ===
                (null === (o = t.positioning) || void 0 === o
                  ? void 0
                  : o.forceY) && this.simulation.force("y", null),
              t.centering)
            ) {
              const e = (function (t, e) {
                ...
                function o() {
                  var o,
                    ...
                    a = 0,
                    h = 0;
                  for (o = 0; o < r; ++o) (a += (s = i[o]).x), (h += s.y);
                  for (
                    a = (a / r - t) * n, h = (h / r - e) * n, o = 0;
                    o < r;
                    ++o
                  )
                    ((s = i[o]).x -= a), (s.y -= h);
              ...
              })(t.centering.x, t.centering.y).strength(t.centering.strength);
              this.simulation.force("center", e);
            }
            null === t.centering && this.simulation.force("center", null);
          }
          runSimulation(t) {
            if (this._isStabilizing) return;
            (this.settings.isPhysicsEnabled ||
              (null == t ? void 0 : t.isUpdatingSettings)) &&
              this.releaseNodes(),
              this.emit(Rn.SIMULATION_START, void 0),
              (this._isStabilizing = !0),
              this.simulation
                .alpha(this.settings.alpha.alpha)
                .alphaTarget(this.settings.alpha.alphaTarget)
                .stop();
            const e = Math.ceil(
              Math.log(this.settings.alpha.alphaMin) /
                Math.log(1 - this.settings.alpha.alphaDecay)
            );
            let i = -1;
            for (let t = 0; t < e; t++) {
              const n = Math.round((100 * t) / e);
              n > i &&
                ((i = n),
                this.emit(Rn.SIMULATION_PROGRESS, {
                  nodes: this._nodes,
                  edges: this._edges,
                  progress: n / 100,
                })),
          ...
          setNodeIndexByNodeId() {
            ...
            for (let t = 0; t < this._nodes.length; t++)
              this._nodeIndexByNodeId[this._nodes[t].id] = t;
          }
          fixNodes(t) {
            t || (t = this._nodes);
            for (let e = 0; e < t.length; e++) Hn(this._nodes[e]);
          }
          releaseNodes(t) {
            t || (t = this._nodes);
            for (let e = 0; e < t.length; e++) Un(this._nodes[e]);
          }
        }
        const Hn = (t) => {
            (t.fx = t.x), (t.fy = t.y);
        ...
        class Gn extends cn {
          constructor() {
            super(),
              (this.simulator = new jn()),
              this.simulator.on(Rn.SIMULATION_START, () => {
                this.emit(un.SIMULATION_START, void 0);
              }),
              this.simulator.on(Rn.SIMULATION_PROGRESS, (t) => {
                this.emit(un.SIMULATION_PROGRESS, t);
              }),
              this.simulator.on(Rn.SIMULATION_END, (t) => {
                this.emit(un.SIMULATION_END, t);
              }),
              this.simulator.on(Rn.NODE_DRAG, (t) => {
                this.emit(un.NODE_DRAG_END, t);
              }),
              this.simulator.on(Rn.TICK, (t) => {
                this.emit(un.NODE_DRAG, t);
              }),
              this.simulator.on(Rn.END, (t) => {
                this.emit(un.NODE_DRAG_END, t);
              }),
              this.simulator.on(Rn.SETTINGS_UPDATE, (t) => {
                this.emit(un.SETTINGS_UPDATE, t);
              });
          }
          setData(t, e) {
            this.simulator.setData({ nodes: t, edges: e });
          }
          addData(t, e) {
            this.simulator.addData({ nodes: t, edges: e });
          }
          updateData(t, e) {
            this.simulator.updateData({ nodes: t, edges: e });
          }
          clearData() {
          ...
          startSimulation(t, e) {
            this.simulator.startSimulation({ nodes: t, edges: e });
          }
          updateSimulation(t, e) {
            this.simulator.updateSimulation({ nodes: t, edges: e });
          }
          stopSimulation() {
          ...
          dragNode(t, e) {
            this.simulator.dragNode(Object.assign({ id: t }, e));
          }
          endDragNode(t) {
            this.simulator.endDragNode({ id: t });
          }
          fixNodes(t) {
            this.simulator.fixNodes(t);
          }
          releaseNodes(t) {
            this.simulator.releaseNodes(t);
          }
          setSettings(t) {
            this.simulator.setSettings(t);
          }
          terminate() {
            this.simulator.removeAllListeners(), this.removeAllListeners();
          }
        }
        var Wn, Fn, qn, Vn, Kn;
        !(function (t) {
          (t.SetData = "Set Data"),
            ...
            (t.Simulate = "Simulate"),
            (t.ActivateSimulation = "Activate Simulation"),
            (t.StartSimulation = "Start Simulation"),
            (t.UpdateSimulation = "Update Simulation"),
            (t.StopSimulation = "Stop Simulation"),
            (t.StartDragNode = "Start Drag Node"),
            (t.DragNode = "Drag Node"),
            (t.EndDragNode = "End Drag Node"),
            (t.FixNodes = "Fix Nodes"),
            (t.ReleaseNodes = "Release Nodes"),
            (t.SetSettings = "Set Settings");
        })(Wn || (Wn = {})),
          (function (t) {
            (t.SIMULATION_START = "simulation-start"),
              (t.SIMULATION_PROGRESS = "simulation-progress"),
        ...
        class Yn extends cn {
          constructor() {
            super(),
              (this.worker = new Worker(new URL(i.p + i.u(79), i.b), {
                type: void 0,
              })),
              (this.worker.onmessage = ({ data: t }) => {
                switch (t.type) {
                  case Fn.SIMULATION_START:
                    this.emit(un.SIMULATION_START, void 0);
                    break;
                  case Fn.SIMULATION_PROGRESS:
                    this.emit(un.SIMULATION_PROGRESS, t.data);
                    break;
                  case Fn.SIMULATION_END:
                    this.emit(un.SIMULATION_END, t.data);
                    break;
                  case Fn.NODE_DRAG:
                    this.emit(un.NODE_DRAG, t.data);
                    break;
                  case Fn.NODE_DRAG_END:
                    this.emit(un.NODE_DRAG_END, t.data);
                    break;
                  case Fn.SETTINGS_UPDATE:
                    this.emit(un.SETTINGS_UPDATE, t.data);
                }
              });
          }
          setData(t, e) {
          ...
          clearData() {
            this.emitToWorker({ type: Wn.ClearData });
          }
          simulate() {
            this.emitToWorker({ type: Wn.Simulate });
          }
          activateSimulation() {
            this.emitToWorker({ type: Wn.ActivateSimulation });
          }
          startSimulation(t, e) {
            this.emitToWorker({
              type: Wn.StartSimulation,
              data: { nodes: t, edges: e },
            });
          }
          updateSimulation(t, e) {
            this.emitToWorker({
              type: Wn.UpdateSimulation,
              data: { nodes: t, edges: e },
            });
          }
          stopSimulation() {
            this.emitToWorker({ type: Wn.StopSimulation });
          }
          startDragNode() {
            this.emitToWorker({ type: Wn.StartDragNode });
          }
          dragNode(t, e) {
            this.emitToWorker({
              type: Wn.DragNode,
              data: Object.assign({ id: t }, e),
            });
          }
          endDragNode(t) {
            this.emitToWorker({ type: Wn.EndDragNode, data: { id: t } });
          }
          fixNodes(t) {
            this.emitToWorker({ type: Wn.FixNodes, data: { nodes: t } });
          }
          releaseNodes(t) {
            this.emitToWorker({ type: Wn.ReleaseNodes, data: { nodes: t } });
          }
          setSettings(t) {
            this.emitToWorker({ type: Wn.SetSettings, data: t });
          }
          terminate() {
        ...
        class Xn {
          static getSimulator() {
            try {
              if ("undefined" != typeof Worker) return new Yn();
              throw new Error(
                "WebWorkers are unavailable in your environment."
              );
            } catch (t) {
              return (
                console.error(
        ...
        !(function (t) {
          (t.RENDER_START = "render-start"),
            (t.RENDER_END = "render-end"),
            (t.SIMULATION_START = "simulation-start"),
            (t.SIMULATION_STEP = "simulation-step"),
            (t.SIMULATION_END = "simulation-end"),
            (t.NODE_CLICK = "node-click"),
            (t.NODE_HOVER = "node-hover"),
            (t.EDGE_CLICK = "edge-click"),
            (t.EDGE_HOVER = "edge-hover"),
            (t.MOUSE_CLICK = "mouse-click"),
            (t.MOUSE_MOVE = "mouse-move"),
            (t.TRANSFORM = "transform"),
            (t.NODE_DRAG_START = "node-drag-start"),
            (t.NODE_DRAG = "node-drag"),
            (t.NODE_DRAG_END = "node-drag-end"),
            (t.NODE_RIGHT_CLICK = "node-right-click"),
            (t.EDGE_RIGHT_CLICK = "edge-right-click"),
            (t.MOUSE_RIGHT_CLICK = "mouse-right-click"),
            (t.NODE_DOUBLE_CLICK = "node-double-click"),
            (t.EDGE_DOUBLE_CLICK = "edge-double-click"),
            (t.MOUSE_DOUBLE_CLICK = "mouse-double-click");
        })(qn || (qn = {}));
        class $n extends cn {}
        !(function (t) {
          (t.CANVAS = "canvas"), (t.WEBGL = "webgl");
        })(Vn || (Vn = {})),
          (function (t) {
            (t.RENDER_START = "render-start"), (t.RENDER_END = "render-end");
          })(Kn || (Kn = {}));
        const Jn = {
            fps: 60,
            minZoom: 0.25,
            ...
            fitZoomMargin: 0.2,
            labelsIsEnabled: !0,
            labelsOnEventIsEnabled: !0,
            shadowIsEnabled: !0,
            shadowOnEventIsEnabled: !0,
            contextAlphaOnEvent: 0.3,
            contextAlphaOnEventIsEnabled: !0,
            backgroundColor: null,
          },
          Qn = "Roboto, sans-serif";
        var to;
        !(function (t) {
        ...
        class eo {
          constructor(t, e) {
            ...
            (this.textLines = []),
              (this.fontSize = 4),
              (this.fontFamily = so(4, Qn)),
              (this.text = `${void 0 === t ? "" : t}`),
              (this.textLines = ro(this.text)),
              (this.position = e.position),
              (this.properties = e.properties),
              (this.textBaseline = e.textBaseline),
              (void 0 !== this.properties.fontSize ||
                this.properties.fontFamily) &&
                ((this.fontSize = Math.max(
                  null !== (i = this.properties.fontSize) && void 0 !== i
                    ? i
                    : 0,
                  0
                )),
                (this.fontFamily = so(
                  this.fontSize,
                  null !== (n = this.properties.fontFamily) && void 0 !== n
                    ? n
                    : Qn
                ))),
              this._fixPosition();
          ...
          _fixPosition() {
            if (this.textBaseline === to.MIDDLE && this.textLines.length) {
              const t = Math.floor(this.textLines.length / 2),
                e = (this.textLines.length - 1) / 2;
              this.position.y -= e * this.fontSize - t * (1.2 - 1);
            }
          }
        }
        const io = (t, e) => {
            e.textLines.length > 0 &&
              e.fontSize > 0 &&
              e.position &&
              (no(t, e), oo(t, e));
          },
          no = (t, e) => {
            if (!e.properties.fontBackgroundColor || !e.position) return;
            t.fillStyle = e.properties.fontBackgroundColor.toString();
            const i = 0.12 * e.fontSize,
              n = e.fontSize + 2 * i,
              o = 1.2 * e.fontSize,
              s = e.textBaseline === to.MIDDLE ? e.fontSize / 2 : 0;
            for (let r = 0; r < e.textLines.length; r++) {
              const a = e.textLines[r],
                h = t.measureText(a).width + 2 * i;
              t.fillRect(
                e.position.x - h / 2,
                e.position.y - s - i + r * o,
                h,
                n
              );
            }
          ...
          oo = (t, e) => {
            ...
            (t.fillStyle = (
              null !== (i = e.properties.fontColor) && void 0 !== i
                ? i
                : "#000000"
            ).toString()),
              (t.font = e.fontFamily),
              ...
              (t.textAlign = "center");
            const n = 1.2 * e.fontSize;
            for (let i = 0; i < e.textLines.length; i++) {
              const o = e.textLines[i];
              t.fillText(o, e.position.x, e.position.y + i * n);
            }
          },
          so = (t, e) => `${t}px ${e}`,
          ro = (t) => {
          ...
          ao = (t, e, i) => {
            const n = t.startNode.getCenter(),
              o = t.endNode.getCenter();
            if (!n || !o) return { x: 0, y: 0 };
            const s = e;
            return {
              x:
                Math.pow(1 - s, 2) * n.x +
          ...
          ho = (t, e) => {
            const i = 2 * e * Math.PI;
            return {
              x: t.x + t.radius * Math.cos(i),
              y: t.y - t.radius * Math.sin(i),
            };
          },
          lo = (t) => {
            if (t instanceof p)
              return ((t) => {
                var e, i;
                const n =
                    null !== (e = t.style.arrowSize) && void 0 !== e ? e : 1,
                  o = null !== (i = t.getWidth()) && void 0 !== i ? i : 1,
                  s = t.startNode.getCenter(),
                  r = t.endNode.getCenter(),
                  a = Math.atan2(r.y - s.y, r.x - s.x),
                  h = ((t, e) => {
                    let i = t.endNode,
                      n = t.startNode;
                    e.id === t.startNode.id &&
                      ((i = t.startNode), (n = t.endNode));
                    const o = i.getCenter(),
                      s = n.getCenter(),
                      r = o.x - s.x,
                      a = o.y - s.y,
                      h = Math.sqrt(r * r + a * a),
                      l = (h - e.getDistanceToBorder()) / h;
                    return {
                      x: (1 - l) * s.x + l * o.x,
                      y: (1 - l) * s.y + l * o.y,
                      t: 0,
                ...
                return {
                  point: h,
                  core: {
                    x: h.x - 0.9 * l * Math.cos(a),
                    y: h.y - 0.9 * l * Math.sin(a),
                  },
                  angle: a,
                  length: l,
                };
                ...
                const n =
                  ...
                  a = ((t, e) => {
                    let i,
                      ...
                      a = 1,
                      h = { x: 0, y: 0, t: 0 };
                    const l = t.getCurvedControlPoint();
                    let u = t.endNode,
                      c = !1;
                    e.id === t.startNode.id && ((u = t.startNode), (c = !0));
                    const d = u.getCenter();
                    let _;
                    for (
                      ;
                      ...
                      s < 10 &&
                      ((_ = 0.5 * (r + a)),
                      (h = Object.assign(Object.assign({}, ao(t, _, l)), {
                        t: 0,
                      })),
                      (i = u.getDistanceToBorder()),
                      (n = Math.sqrt(
                        Math.pow(h.x - d.x, 2) + Math.pow(h.y - d.y, 2)
                      )),
                      (o = i - n),
                      !(Math.abs(o) < 0.2));
                      ...
                      o < 0
                        ...
                        : (r = _),
                        s++;
                    return (h.t = null != _ ? _ : 0), h;
                  })(t, s),
                  h = ao(t, Math.max(0, Math.min(1, a.t + -0.1)), r),
                  l = Math.atan2(a.y - h.y, a.x - h.x),
                  u = 1.5 * n + 3 * o;
                return {
                  point: a,
                  core: {
                    x: a.x - 0.9 * u * Math.cos(l),
                    y: a.y - 0.9 * u * Math.sin(l),
                  },
                  angle: l,
                  length: u,
                };
                ...
                const n =
                  ...
                  s = ((t, e) => {
                    ...
                    for (
                      ...
                      h < 10 &&
                      ((u = 0.5 * (r + a)),
                      (l = Object.assign(Object.assign({}, ho(i, u)), {
                        t: 0,
                      })),
                      (n = e.getDistanceToBorder()),
                      (o = Math.sqrt(
                        Math.pow(l.x - c.x, 2) + Math.pow(l.y - c.y, 2)
                      )),
                      (s = n - o),
                      !(Math.abs(s) < 0.05));
                      ...
                      s > 0 ? (r = u) : (a = u), h++;
                    return (l.t = null != u ? u : 0), l;
                  })(t, t.startNode),
                  r = -2 * s.t * Math.PI + 0.45 * Math.PI,
                  a = 1.5 * n + 3 * o;
                return {
                  point: s,
                  core: {
                    x: s.x - 0.9 * a * Math.cos(r),
                    y: s.y - 0.9 * a * Math.sin(r),
                  },
                  angle: r,
                  length: a,
                };
          ...
          uo = (t, e) => {
            ...
            for (let e = 0; e < t.length; e++) {
              const r = t[e],
                a = r.x * Math.cos(o) - r.y * Math.sin(o),
                h = r.x * Math.sin(o) + r.y * Math.cos(o);
              (r.x = i + s * a), (r.y = n + s * h);
            }
            return t;
          },
            ...
            switch (e.style.shape) {
              ...
              case s.STAR:
                ((t, e, i, n) => {
                  ...
                  for (let o = 0; o < 10; o++) {
                    const s = n * (o % 2 == 0 ? 1.3 : 0.5),
                      r = e + s * Math.sin((2 * o * Math.PI) / 10),
                      a = i - s * Math.cos((2 * o * Math.PI) / 10);
                    t.lineTo(r, a);
                  }
                  t.closePath();
                })(t, i.x, i.y, n);
          ...
          _o = (t, e = 300) => {
            ...
            return function () {
              const s = arguments,
                r = Date.now();
              if (!n) return t(...s), (o = r), void (n = !0);
              clearTimeout(i);
              const a = Math.max(e - (r - o), 0);
              i = setTimeout(() => {
                r - o >= e && (t(...s), (o = r));
              }, a);
            };
          ...
          fo = (t) => {
            const e = Math.max(t, 1);
            return Math.round(1e3 / e);
          };
        class po extends cn {
          constructor(t, e) {
            super(),
              (this._isOriginCentered = !1),
              (this._isInitiallyRendered = !1),
              (this._context = t),
              (this.width = 640),
              (this.height = 480),
              (this.transform = Qi),
              (this._settings = Object.assign(Object.assign({}, Jn), e)),
              (this._throttleRender = _o((t) => {
                this._render(t);
              }, fo(this._settings.fps)));
          }
          get isInitiallyRendered() {
            return this._isInitiallyRendered;
          }
          getSettings() {
            return zn(this._settings);
          }
          setSettings(t) {
            const e = t.fps && t.fps !== this._settings.fps;
          ...
          render(t) {
            this._throttleRender(t);
          }
          _render(t) {
            if (!t.getNodeCount()) return;
            this.emit(Kn.RENDER_START, void 0);
            const e = Date.now();
            this._context.clearRect(0, 0, this.width, this.height),
              this._settings.backgroundColor &&
                ((this._context.fillStyle =
                  this._settings.backgroundColor.toString()),
                this._context.fillRect(0, 0, this.width, this.height)),
              this._context.save(),
              this._context.translate(this.transform.x, this.transform.y),
              this._context.scale(this.transform.k, this.transform.k),
              this._isOriginCentered &&
                this._context.translate(this.width / 2, this.height / 2),
              this.drawObjects(t.getEdges()),
              this.drawObjects(t.getNodes()),
              this._context.restore(),
              this.emit(Kn.RENDER_END, { durationMs: Date.now() - e }),
              (this._isInitiallyRendered = !0);
          }
          drawObjects(t) {
            ...
            for (let n = 0; n < t.length; n++) {
              const o = t[n];
              o.isSelected() && e.push(o), o.isHovered() && i.push(o);
            }
            const n = e.length || i.length;
            this._settings.contextAlphaOnEventIsEnabled &&
              n &&
          ...
          drawObject(t, e) {
            a(t)
              ? ((t, e, i) => {
                  var n, o;
                  const s =
                      null === (n = null == i ? void 0 : i.isShadowEnabled) ||
                      void 0 === n ||
                      n,
                    r =
                      null === (o = null == i ? void 0 : i.isLabelEnabled) ||
                      void 0 === o ||
                      o,
                    a = e.hasShadow();
                  ((t, e) => {
                    if (e.hasBorder()) {
                      t.lineWidth = e.getBorderWidth();
                      const i = e.getBorderColor();
                      i && (t.strokeStyle = i.toString());
                    }
                    const i = e.getColor();
                    i && (t.fillStyle = i.toString());
                  })(t, e),
                    s &&
                      a &&
                      ((t, e) => {
                        e.style.shadowColor &&
                          (t.shadowColor = e.style.shadowColor.toString()),
                          e.style.shadowSize &&
                            (t.shadowBlur = e.style.shadowSize),
                          e.style.shadowOffsetX &&
                            (t.shadowOffsetX = e.style.shadowOffsetX),
                          e.style.shadowOffsetY &&
                            (t.shadowOffsetY = e.style.shadowOffsetY);
                      })(t, e),
                    co(t, e),
                    t.fill();
                  const h = e.getBackgroundImage();
                  h &&
                    ((t, e, i) => {
                      if (!i.width || !i.height) return;
                      const n = e.getCenter(),
                        o = e.getRadius(),
                        s = Math.max((2 * o) / i.width, (2 * o) / i.height),
                        r = i.height * s,
                        a = i.width * s;
                      t.save(),
                        t.clip(),
                        t.drawImage(i, n.x - a / 2, n.y - r / 2, a, r),
                        t.restore();
                    })(t, e, h),
                    s &&
                      a &&
                      ((t, e) => {
                        e.style.shadowColor &&
                          ...
                          e.style.shadowSize && (t.shadowBlur = 0),
                          e.style.shadowOffsetX && (t.shadowOffsetX = 0),
                          e.style.shadowOffsetY && (t.shadowOffsetY = 0);
                      })(t, e),
                    e.hasBorder() && t.stroke(),
                    r &&
                      ((t, e) => {
                        const i = e.getLabel();
                        if (!i) return;
                        const n = e.getCenter(),
                          o = 1.2 * e.getBorderedRadius(),
                          s = new eo(i, {
                            position: { x: n.x, y: n.y + o },
                            textBaseline: to.TOP,
                            properties: {
                              fontBackgroundColor: e.style.fontBackgroundColor,
              ...
              : ((t, e, i) => {
                  ...
                  ((t, e) => {
                    ...
                    const n = e.getColor();
                    n &&
                      ((t.strokeStyle = n.toString()),
                      (t.fillStyle = n.toString()));
                  })(t, e),
                    s &&
                      a &&
                      ((t, e) => {
                    ...
                    ((t, e) => {
                      ...
                      for (let e = 0; e < n.length; e++) {
                        const i = n[e];
                        0 !== e ? t.lineTo(i.x, i.y) : t.moveTo(i.x, i.y);
                      }
                      t.closePath(), t.fill();
                    })(t, e),
                    ((t, e) => {
                      if (e instanceof p)
                        return ((t, e) => {
                          const i = e.startNode.getCenter(),
                            n = e.endNode.getCenter();
                          i &&
                            n &&
                            (t.beginPath(),
                            t.moveTo(i.x, i.y),
                      ...
                      if (e instanceof g)
                        return ((t, e) => {
                          const i = e.startNode.getCenter(),
                            n = e.endNode.getCenter();
                          if (!i || !n) return;
                          const o = e.getCurvedControlPoint();
                          t.beginPath(),
                            t.moveTo(i.x, i.y),
                            t.quadraticCurveTo(o.x, o.y, n.x, n.y),
                            t.stroke();
                        })(t, e);
                      if (e instanceof m)
                        return ((t, e) => {
                          const { x: i, y: n, radius: o } = e.getCircularData();
                          t.beginPath(),
                            t.arc(i, n, o, 0, 2 * Math.PI, !1),
                            t.closePath(),
                            t.stroke();
                        })(t, e);
                      throw new Error("Failed to draw unsupported edge type");
          ...
          getFitZoomTransform(t) {
            const e = t.getBoundingBox(),
              i = e.x + e.width / 2,
              n = e.y + e.height / 2,
              o = this.getSimulationViewRectangle(),
              s = o.height / (e.height * (1 + this._settings.fitZoomMargin)),
              r = o.width / (e.width * (1 + this._settings.fitZoomMargin)),
              a = Math.min(s, r),
              h = this.transform.k,
              l = Math.max(
                Math.min(a * h, this._settings.maxZoom),
                this._settings.minZoom
              ),
              u = (o.width / 2) * h * (1 - l) - i * l,
              c = (o.height / 2) * h * (1 - l) - n * l;
            return Qi.translate(u, c).scale(l);
          }
          getSimulationPosition(t) {
            const [e, i] = this.transform.invert([t.x, t.y]);
            return { x: e - this.width / 2, y: i - this.height / 2 };
          }
          getSimulationViewRectangle() {
            const t = this.getSimulationPosition({ x: 0, y: 0 }),
              e = this.getSimulationPosition({ x: this.width, y: this.height });
            return { x: t.x, y: t.y, width: e.x - t.x, height: e.y - t.y };
          }
          translateOriginToCenter() {
            this._isOriginCentered = !0;
          }
        }
        class go extends cn {
          constructor(t, e) {
          ...
          render(t) {
            throw (
              (console.log("graph:", t), new Error("Method not implemented."))
            );
          }
          reset() {
            throw new Error("Method not implemented.");
        ...
        class vo {
          static getRenderer(t, e = Vn.CANVAS, i) {
            if (e === Vn.WEBGL) {
              const e = t.getContext("webgl2");
              if (!e) throw new mo("Failed to create WebGL context.");
              return new go(e, i);
            }
            const n = t.getContext("2d");
            if (!n) throw new mo("Failed to create Canvas context.");
            return new po(n, i);
          }
        }
        const yo = (t, e = !1) => {
            ...
            i.display ||
              ...
              console.warn(
                "[Orb] Graph container doesn't have defined 'display' property. Setting 'display' to 'block'..."
              )),
              !e &&
                wo(i.width) &&
                ((t.style.width = "100%"),
                wo(getComputedStyle(t).width)
                  ? ((t.style.width = "400px"),
                    console.warn(
                  ...
                  : console.warn(
                      "[Orb] The graph container element doesn't have defined width. Setting width to 100%..."
                    )),
              !e &&
                wo(i.height) &&
                ((t.style.height = "100%"),
                wo(getComputedStyle(t).height)
                  ...
                  : console.warn(
                      "[Orb] Graph container doesn't have defined height. Setting height to 100%..."
                    ));
          },
          xo = /^\s*0+\s*(?:px|rem|em|vh|vw)?\s*$/i,
          wo = (t) => null == t || "" === t || xo.test(t);
        class bo {
          constructor(t, e) {
            var i;
            (this._isSimulating = !1),
              ...
              (this.dragSubject = (t) => {
                var e;
                const i = this.getCanvasMousePosition(t.sourceEvent),
                  n =
                    null === (e = this._renderer) || void 0 === e
                      ? void 0
                      : e.getSimulationPosition(i);
                return this._graph.getNearestNode(n);
              }),
              (this.dragStarted = (t) => {
                const e = this.getCanvasMousePosition(t.sourceEvent),
                  i = this._renderer.getSimulationPosition(e);
                this._events.emit(qn.NODE_DRAG_START, {
                  node: t.subject,
                  event: t.sourceEvent,
                  localPoint: i,
                  globalPoint: e,
                }),
                  (this._dragStartPosition = e);
              }),
              (this.dragged = (t) => {
                const e = this.getCanvasMousePosition(t.sourceEvent),
                  i = this._renderer.getSimulationPosition(e);
                ln(this._dragStartPosition, e) ||
                  (this._dragStartPosition = void 0),
                  this._simulator.dragNode(t.subject.id, i),
                  this._events.emit(qn.NODE_DRAG, {
                    node: t.subject,
                    event: t.sourceEvent,
                    localPoint: i,
                    globalPoint: e,
              ...
              (this.dragEnded = (t) => {
                const e = this.getCanvasMousePosition(t.sourceEvent),
                  i = this._renderer.getSimulationPosition(e);
                ln(this._dragStartPosition, e) ||
                  this._simulator.endDragNode(t.subject.id),
                  this._events.emit(qn.NODE_DRAG_END, {
                    node: t.subject,
                    event: t.sourceEvent,
                    localPoint: i,
                    globalPoint: e,
              ...
              (this.zoomed = (t) => {
                (this._renderer.transform = t.transform),
                  setTimeout(() => {
                    this._renderer.render(this._graph),
                      this._events.emit(qn.TRANSFORM, {
                        transform: t.transform,
                      });
                  }, 1);
              }),
              (this.mouseMoved = (t) => {
                const e = this.getCanvasMousePosition(t),
                  i = this._renderer.getSimulationPosition(e);
                if (this._strategy.onMouseMove) {
                  const n = this._strategy.onMouseMove(this._graph, i),
                    o = n.changedSubject;
                  o &&
                    n.isStateChanged &&
                    (a(o) &&
                      this._events.emit(qn.NODE_HOVER, {
                        node: o,
                        event: t,
                        localPoint: i,
                        globalPoint: e,
                    ...
                    d(o) &&
                      this._events.emit(qn.EDGE_HOVER, {
                        edge: o,
                        event: t,
                        localPoint: i,
                        globalPoint: e,
                      })),
                    this._events.emit(qn.MOUSE_MOVE, {
                      subject: o,
                      event: t,
                      localPoint: i,
                      globalPoint: e,
                    }),
                    n.isStateChanged && this._renderer.render(this._graph);
                }
              }),
              (this.mouseClicked = (t) => {
                const e = this.getCanvasMousePosition(t),
                ...
                if (this._strategy.onMouseClick) {
                  const n = this._strategy.onMouseClick(this._graph, i),
                    o = n.changedSubject;
                  o &&
                    (a(o) &&
                      this._events.emit(qn.NODE_CLICK, {
                        node: o,
                        event: t,
                        localPoint: i,
                        globalPoint: e,
                    ...
                    d(o) &&
                      this._events.emit(qn.EDGE_CLICK, {
                        edge: o,
                        event: t,
                        localPoint: i,
                        globalPoint: e,
                      })),
                    this._events.emit(qn.MOUSE_CLICK, {
                      subject: o,
                      event: t,
                      localPoint: i,
                      globalPoint: e,
                    }),
                    (n.isStateChanged || n.changedSubject) &&
                      this._renderer.render(this._graph);
                }
              }),
              (this.mouseRightClicked = (t) => {
                const e = this.getCanvasMousePosition(t),
                  i = this._renderer.getSimulationPosition(e);
                if (this._strategy.onMouseRightClick) {
                  const n = this._strategy.onMouseRightClick(this._graph, i),
                    o = n.changedSubject;
                  o &&
                    (a(o) &&
                      this._events.emit(qn.NODE_RIGHT_CLICK, {
                        node: o,
                        event: t,
                        localPoint: i,
                        globalPoint: e,
                    ...
                    d(o) &&
                      this._events.emit(qn.EDGE_RIGHT_CLICK, {
                        edge: o,
                        event: t,
                        localPoint: i,
                        globalPoint: e,
                      })),
                    this._events.emit(qn.MOUSE_RIGHT_CLICK, {
                      subject: o,
                      event: t,
                      localPoint: i,
                      globalPoint: e,
              ...
              (this.mouseDoubleClicked = (t) => {
                const e = this.getCanvasMousePosition(t),
                  i = this._renderer.getSimulationPosition(e);
                if (this._strategy.onMouseDoubleClick) {
                  const n = this._strategy.onMouseDoubleClick(this._graph, i),
                    o = n.changedSubject;
                  o &&
                    (a(o) &&
                      this._events.emit(qn.NODE_DOUBLE_CLICK, {
                        node: o,
                        event: t,
                        localPoint: i,
                        globalPoint: e,
                    ...
                    d(o) &&
                      this._events.emit(qn.EDGE_DOUBLE_CLICK, {
                        edge: o,
                        event: t,
                        localPoint: i,
                        globalPoint: e,
                      })),
                    this._events.emit(qn.MOUSE_DOUBLE_CLICK, {
                      subject: o,
                      event: t,
                      localPoint: i,
                      globalPoint: e,
              ...
              (this._strategy = t.strategy),
              (this._settings = Object.assign(
                Object.assign(
                  {
                    getPosition: null == e ? void 0 : e.getPosition,
                    zoomFitTransitionMs: 200,
                    isOutOfBoundsDragEnabled: !1,
                    areCoordinatesRounded: !0,
                    isSimulationAnimated: !0,
                    areCollapsedContainerDimensionsAllowed: !1,
                  },
                  e
                ),
                {
                  simulation: Object.assign(
                    { isPhysicsEnabled: !1 },
                    null == e ? void 0 : e.simulation
                  ),
                  render: Object.assign({}, null == e ? void 0 : e.render),
                }
              )),
              yo(
                this._container,
                this._settings.areCollapsedContainerDimensionsAllowed
              ),
              (this._canvas = this._initCanvas());
            try {
              this._renderer = vo.getRenderer(
                this._canvas,
                null === (i = null == e ? void 0 : e.render) || void 0 === i
                  ? void 0
                  : i.type,
                this._settings.render
              );
            } catch (t) {
              throw ((this._container.textContent = t.message), t);
            }
            this._renderer.on(Kn.RENDER_START, () => {
              this._events.emit(qn.RENDER_START, void 0);
            }),
              this._renderer.on(Kn.RENDER_END, (t) => {
                this._events.emit(qn.RENDER_END, t);
              }),
              ...
              (this._d3Zoom = (function () {
                ...
                function v(t, e) {
                  return (e = Math.max(h[0], Math.min(h[1], e))) === t.k
                    ? t
                    : new Ji(e, t.x, t.y);
                }
                function y(t, e, i) {
                  var n = e[0] - i[0] * t.k,
                    o = e[1] - i[1] * t.k;
                  return n === t.x && o === t.y ? t : new Ji(t.k, n, o);
                }
                function x(t) {
                  ...
                  t.on("start.zoom", function () {
                    ...
                    .tween("zoom", function () {
                      var t = this,
                        ...
                        u = t.__zoom,
                        d = "function" == typeof e ? e.apply(t, s) : e,
                        _ = c(
                          u.invert(h).concat(l / u.k),
                          d.invert(h).concat(l / d.k)
                        );
                      return function (t) {
                        if (1 === t) t = d;
                        else {
                          var e = _(t),
                            i = l / e[2];
                          t = new Ji(i, h[0] - e[0] * i, h[1] - e[1] * i);
                        }
                        r.zoom(null, t);
                      };
                    });
                ...
                function b(t, e, i) {
                  return (!i && t.__zooming) || new P(t, e);
                }
                function P(t, e) {
                  (this.that = t),
                    (this.args = e),
                ...
                function S(t, ...e) {
                  if (n.apply(this, arguments)) {
                    var i = b(this, e).event(t),
                      o = this.__zoom,
                      a = Math.max(
                        h[0],
                        Math.min(
                          h[1],
                          o.k * Math.pow(2, r.apply(this, arguments))
                        )
                      ),
                      u = jt(t);
                    if (i.wheel)
                      (i.mouse[0][0] === u[0] && i.mouse[0][1] === u[1]) ||
                        (i.mouse[1] = o.invert((i.mouse[0] = u))),
                        clearTimeout(i.wheel);
                    else {
                      if (o.k === a) return;
                      (i.mouse = [u, o.invert(u)]), Ce(this), i.start();
                    }
                    en(t),
                      ...
                      i.zoom(
                        "mouse",
                        s(y(v(o, a), i.mouse[0], i.mouse[1]), i.extent, l)
                      );
                  }
                }
                function T(t, ...e) {
                  if (!i && n.apply(this, arguments)) {
                    var o = t.currentTarget,
                      r = b(this, e, !0).event(t),
                      a = Zt(t.view)
                        .on(
                          "mousemove.zoom",
                          function (t) {
                    ...
                    Ft(t.view),
                      tn(t),
                      (r.mouse = [h, this.__zoom.invert(h)]),
                      Ce(this),
                      r.start();
                  }
                }
                function L(t, ...e) {
                  if (n.apply(this, arguments)) {
                    var i = this.__zoom,
                      r = jt(t.changedTouches ? t.changedTouches[0] : t, this),
                      a = i.invert(r),
                      h = i.k * (t.shiftKey ? 0.5 : 2),
                      c = s(y(v(i, h), r, a), o.apply(this, e), l);
                    en(t),
                      u > 0
                        ? Zt(this).transition().duration(u).call(w, c, r, t)
                        : Zt(this).call(m.transform, c, r, t);
                  }
                }
                function M(i, ...o) {
                  if (n.apply(this, arguments)) {
                    var s,
                      ...
                      l = i.touches,
                      u = l.length,
                      c = b(this, o, i.changedTouches.length === u).event(i);
                    for (tn(i), r = 0; r < u; ++r)
                      (h = [
                        (h = jt((a = l[r]), this)),
                  ...
                  if (this.__zooming) {
                    ...
                    if (((n = a.that.__zoom), a.touch1)) {
                      var c = a.touch0[0],
                        ...
                        _ = a.touch1[0],
                        f = a.touch1[1],
                        p = (p = _[0] - c[0]) * p + (p = _[1] - c[1]) * p,
                        g = (g = f[0] - d[0]) * g + (g = f[1] - d[1]) * g;
                      (n = v(n, Math.sqrt(p / g))),
                        (o = [(c[0] + _[0]) / 2, (c[1] + _[1]) / 2]),
                        (r = [(d[0] + f[0]) / 2, (d[1] + f[1]) / 2]);
                    } else {
                      if (!a.touch0) return;
                      (o = a.touch0[0]), (r = a.touch0[1]);
                    }
                    a.zoom("touch", s(y(n, o, r), a.extent, l));
                  }
                }
                function N(t, ...n) {
                  if (this.__zooming) {
                    ...
                    if (
                      ...
                      2 === r.taps &&
                        ((s = jt(s, this)),
                        Math.hypot(e[0] - s[0], e[1] - s[1]) < g))
                    ) {
                      var l = Zt(this).on("dblclick.zoom");
                      l && l.apply(this, arguments);
                    }
                  }
                }
                return (
                  (m.transform = function (t, e, i, n) {
                    var o = t.selection ? t.selection() : t;
                    o.property("__zoom", sn),
                      t !== o
                        ? w(t, e, i, n)
                        ...
                        var t = o.apply(this, arguments),
                          ...
                          h =
                            "function" == typeof e
                              ? e.apply(this, arguments)
                              : e;
                        return s(y(v(n, h), r, a), t, l);
                      },
                      i,
                      n
                    );
                  }),
                  (m.translateBy = function (t, e, i, n) {
                    m.transform(
                      t,
                      function () {
                        return s(
                  ...
                  (m.translateTo = function (t, e, i, n, r) {
                    m.transform(
                      t,
                      function () {
                        var t = o.apply(this, arguments),
                  ...
                  (m.wheelDelta = function (t) {
                    return arguments.length
                      ? ((r = "function" == typeof t ? t : Xi(+t)), m)
                      : r;
                  }),
                  (m.filter = function (t) {
                    return arguments.length
                      ? ((n = "function" == typeof t ? t : Xi(!!t)), m)
                      : n;
                  }),
                  (m.touchable = function (t) {
                    return arguments.length
                      ? ((a = "function" == typeof t ? t : Xi(!!t)), m)
                      : a;
                  }),
                  (m.extent = function (t) {
                    return arguments.length
                ...
                .scaleExtent([
                  this._renderer.getSettings().minZoom,
                  this._renderer.getSettings().maxZoom,
                ])
                .on("zoom", this.zoomed)),
              Zt(this._canvas)
                .call(
                  (function () {
                    ...
                    function d(t) {
                      t.on("mousedown.drag", _)
                        ...
                        .on("touchmove.drag", m, Ht)
                        .on("touchend.drag touchcancel.drag", v)
                        .style("touch-action", "none")
                        .style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
                    }
                    function _(r, a) {
                      if (!n && o.call(this, r, a)) {
                        var h = y(this, s.call(this, r, a), r, a, "mouse");
                        h &&
                          (Zt(r.view)
                            .on("mousemove.drag", f, Ut)
                            .on("mouseup.drag", p, Ut),
                          Ft(r.view),
                          Gt(r),
                          (i = !1),
                          (t = r.clientX),
                    ...
                    function p(t) {
                      Zt(t.view).on("mousemove.drag mouseup.drag", null),
                        qt(t.view, i),
                        Wt(t),
                        h.mouse("end", t);
                    }
                    function g(t, e) {
                      if (o.call(this, t, e)) {
                        var i,
                          ...
                          h = r.length;
                        for (i = 0; i < h; ++i)
                          (n = y(this, a, t, e, r[i].identifier, r[i])) &&
                            (Gt(t), n("start", t, r[i]));
                      }
                    }
                    function m(t) {
                      var e,
                        ...
                        o = n.length;
                      for (e = 0; e < o; ++e)
                        (i = h[n[e].identifier]) && (Wt(t), i("drag", t, n[e]));
                    }
                    function v(t) {
                      var e,
                        i,
                      ...
                      for (
                        ...
                        (i = h[o[e].identifier]) && (Gt(t), i("end", t, o[e]));
                    }
                    ...
                    return (
                      ...
                      (d.container = function (t) {
                        return arguments.length
                          ? ((s = "function" == typeof t ? t : Vt(t)), d)
                          : s;
                      }),
                      (d.subject = function (t) {
                        return arguments.length
                          ? ((r = "function" == typeof t ? t : Vt(t)), d)
                          : r;
                      }),
              ...
              (this._simulator = Xn.getSimulator()),
              this._simulator.on(un.SIMULATION_START, () => {
                (this._isSimulating = !0),
                  (this._simulationStartedAt = Date.now()),
                  this._events.emit(qn.SIMULATION_START, void 0);
              }),
              this._simulator.on(un.SIMULATION_PROGRESS, (t) => {
                this._graph.setNodePositions(t.nodes),
                  this._events.emit(qn.SIMULATION_STEP, {
                    progress: t.progress,
                  }),
                  this._settings.isSimulationAnimated &&
                    this._renderer.render(this._graph);
              }),
              this._simulator.on(un.SIMULATION_END, (t) => {
                var e;
                this._graph.setNodePositions(t.nodes),
                  this._renderer.render(this._graph),
                  (this._isSimulating = !1),
                  null === (e = this._onSimulationEnd) ||
                    void 0 === e ||
                    e.call(this),
                  (this._onSimulationEnd = void 0),
                  this._events.emit(qn.SIMULATION_END, {
                    durationMs: Date.now() - this._simulationStartedAt,
                  });
              }),
              this._simulator.on(un.NODE_DRAG, (t) => {
                this._graph.setNodePositions(t.nodes),
                  this._renderer.render(this._graph);
              }),
              this._simulator.on(un.SETTINGS_UPDATE, (t) => {
                this._settings.simulation = t.settings;
              }),
          ...
          setSettings(t) {
            t.getPosition && (this._settings.getPosition = t.getPosition),
              t.simulation &&
                ((this._settings.simulation = Object.assign(
                  Object.assign({}, this._settings.simulation),
                  t.simulation
                )),
                this._simulator.setSettings(this._settings.simulation)),
              t.render &&
                (this._renderer.setSettings(t.render),
                (this._settings.render = this._renderer.getSettings()));
          }
          render(t) {
            if (this._isSimulating)
              return (
                this._renderer.render(this._graph), void (null == t || t())
              );
            if (this._settings.getPosition) {
              const t = this._graph.getNodes();
              for (let e = 0; e < t.length; e++) {
                const i = this._settings.getPosition(t[e]);
                i && (t[e].position = Object.assign({ id: t[e].id }, i));
              }
            }
            (this._isSimulating = !0),
              (this._onSimulationEnd = t),
              this._startSimulation();
          }
          recenter(t) {
            const e = this._renderer.getFitZoomTransform(this._graph);
            Zt(this._canvas)
              .transition()
              .duration(this._settings.zoomFitTransitionMs)
              .ease(Qt)
              .call(this._d3Zoom.transform, e)
              .call(() => {
                this._renderer.render(this._graph), null == t || t();
              });
          }
          destroy() {
          ...
          getCanvasMousePosition(t) {
            var e, i, n, o;
            const s = this._canvas.getBoundingClientRect();
            let r =
                null !==
                  (i =
                    null !== (e = t.clientX) && void 0 !== e ? e : t.pageX) &&
                void 0 !== i
                  ? i
                  : t.x,
              a =
                null !==
                  (o =
                    null !== (n = t.clientY) && void 0 !== n ? n : t.pageY) &&
                void 0 !== o
                  ? o
                  : t.y;
            return (
              (r -= s.left),
              (a -= s.top),
              this._settings.areCoordinatesRounded &&
                ((r = Math.floor(r)), (a = Math.floor(a))),
              this._settings.isOutOfBoundsDragEnabled ||
                ((r = Math.max(0, Math.min(this._renderer.width, r))),
                (a = Math.max(0, Math.min(this._renderer.height, a)))),
              { x: r, y: a }
            );
          }
          _initCanvas() {
          ...
          _handleResize() {
            ...
            (this._canvas.width = t.width),
              ...
              (this._renderer.height = t.height),
              this._renderer.isInitiallyRendered &&
                this._renderer.render(this._graph);
          }
          _startSimulation() {
            const t = this._graph.getNodePositions(),
              e = this._graph.getEdgePositions();
            this._simulator.updateData(t, e), this._simulator.simulate();
          }
          fixNodes() {
        ...
        var Po = i(243);
        const So = {
          instance: new Po.TileLayer(
            "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
          ),
          attribution:
            '<a href="https://leafletjs.com/" target="_blank" >Leaflet</a> | Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors',
        };
        class To {
          constructor(t, e) {
            var i, n, o, s, r;
                ...
                ),
                {
                  map: {
                    zoomLevel:
                      null !==
                        (n =
                          null === (i = e.map) || void 0 === i
                            ? void 0
                            : i.zoomLevel) && void 0 !== n
                        ? n
                        : 2,
                    tile:
                      null !==
                        (s =
                          null === (o = e.map) || void 0 === o
                            ? void 0
                            : o.tile) && void 0 !== s
                        ? s
                        : So,
                  },
                  render: Object.assign({ type: Vn.CANVAS }, e.render),
                }
              )),
              yo(this._container),
              (this._canvas = this._initCanvas()),
            ...
            try {
              this._renderer = vo.getRenderer(
                this._canvas,
                null === (r = null == e ? void 0 : e.render) || void 0 === r
                  ? void 0
                  : r.type,
                this._settings.render
              );
          ...
          setSettings(t) {
            t.getGeoPosition &&
              ((this._settings.getGeoPosition = t.getGeoPosition),
              this._updateGraphPositions()),
              t.map &&
                ("number" == typeof t.map.zoomLevel &&
                  ((this._settings.map.zoomLevel = t.map.zoomLevel),
                  this._leaflet.setZoom(t.map.zoomLevel)),
                t.map.tile &&
                  ((this._settings.map.tile = t.map.tile),
                  this._handleTileChange())),
              t.render &&
                (this._renderer.setSettings(t.render),
                (this._settings.render = this._renderer.getSettings()));
          ...
          recenter(t) {
            const e = this._graph.getBoundingBox(),
              i = this._leaflet.layerPointToLatLng([e.x, e.y]),
              n = this._leaflet.layerPointToLatLng([
                e.x + e.width,
                e.y + e.height,
              ]);
            this._leaflet.fitBounds(Po.latLngBounds(i, n)), null == t || t();
          }
          destroy() {
            this._resizeObs.unobserve(this._container),
              this._renderer.removeAllListeners(),
          ...
          _initLeaflet() {
            const t = Po.map(this._map, { doubleClickZoom: !1 }).setView(
              [0, 0],
            ...
            return (
              ...
              t.on("zoom", (t) => {
                ...
                const e = Object.assign(
                  Object.assign({}, t.target._mapPane._leaflet_pos),
                  { k: t.target._zoom }
                );
                this._events.emit(qn.TRANSFORM, { transform: e });
              }),
              t.on("mousemove", (t) => {
                const e = { x: t.layerPoint.x, y: t.layerPoint.y },
                  i = { x: t.containerPoint.x, y: t.containerPoint.y };
                if (this._strategy.onMouseMove) {
                  const n = this._strategy.onMouseMove(this._graph, e),
                    o = n.changedSubject;
                  o &&
                    n.isStateChanged &&
                    (a(o) &&
              ...
              t.on("click contextmenu dblclick", (t) => {
                const e = { x: t.layerPoint.x, y: t.layerPoint.y },
                  i = { x: t.containerPoint.x, y: t.containerPoint.y };
                if (
                  "contextmenu" === t.type &&
                  this._strategy.onMouseRightClick
                ) {
                  const n = this._strategy.onMouseRightClick(this._graph, e),
                    o = n.changedSubject;
                  o &&
                    (a(o) &&
                      this._events.emit(qn.NODE_RIGHT_CLICK, {
                    ...
                    n.isStateChanged && this._renderer.render(this._graph);
                } else if ("click" === t.type && this._strategy.onMouseClick) {
                  const n = this._strategy.onMouseClick(this._graph, e),
                    o = n.changedSubject;
                  o &&
                    (a(o) &&
                      this._events.emit(qn.NODE_CLICK, {
                  ...
                  "dblclick" === t.type &&
                  this._strategy.onMouseDoubleClick
                ) {
                  const n = this._strategy.onMouseDoubleClick(this._graph, e),
                    o = n.changedSubject;
                  if (
                    (o &&
                      (a(o) &&
                    ...
                    const e = t.target._zoom + 1;
                    t.target.setZoomAround(t.layerPoint, e);
                  }
                  (n.isStateChanged || n.changedSubject) &&
                    this._renderer.render(this._graph);
                }
              ...
              t.on("moveend", (t) => {
                const e = t.target._mapPane._leaflet_pos;
                (this._renderer.transform = Object.assign(
                  Object.assign({}, e),
                  { k: 1 }
                )),
                  this._renderer.render(this._graph);
              ...
              t.on("drag", (t) => {
                ...
                this._events.emit(qn.TRANSFORM, { transform: i });
              }),
              t
            );
          }
          _updateGraphPositions() {
            const t = this._graph.getNodes();
            for (let e = 0; e < t.length; e++) {
              const i = this._settings.getGeoPosition(t[e]);
              if (!i) continue;
              if ("number" != typeof i.lat || "number" != typeof i.lng)
                continue;
              const n = this._leaflet.latLngToLayerPoint([i.lat, i.lng]);
              (t[e].position.x = n.x), (t[e].position.y = n.y);
            }
          }
          _handleResize() {
            const t = this._container.getBoundingClientRect();
            (this._canvas.width = t.width),
              ...
              (this._renderer.height = t.height),
              this._renderer.isInitiallyRendered &&
                (this._leaflet.invalidateSize(!1),
                this._renderer.render(this._graph));
          }
          _handleTileChange() {
            const t = this._settings.map.tile;
            this._leaflet.whenReady(() => {
              this._leaflet.attributionControl.setPrefix(t.attribution),
                this._leaflet.eachLayer((t) => this._leaflet.removeLayer(t)),
                t.instance.addTo(this._leaflet);
            });
          }
        }
        class Eo {
          onMouseClick(t, e) {
            const i = t.getNearestNode(e);
            if (i) return Lo(t, i), { isStateChanged: !0, changedSubject: i };
            const n = t.getNearestEdge(e);
            if (n) return Mo(t, n), { isStateChanged: !0, changedSubject: n };
            const { changedCount: o } = Co(t);
            return { isStateChanged: o > 0 };
          }
          onMouseMove(t, e) {
            const i = t.getNearestNode(e);
            if (i && !i.isSelected())
              return i === this.lastHoveredNode
                ? { changedSubject: i, isStateChanged: !1 }
                : (No(t, i),
                  (this.lastHoveredNode = i),
                  { isStateChanged: !0, changedSubject: i });
            if (((this.lastHoveredNode = void 0), !i)) {
              const { changedCount: e } = Oo(t);
              return { isStateChanged: e > 0 };
            }
            return { isStateChanged: !1 };
          }
          onMouseRightClick(t, e) {
            const i = t.getNearestNode(e);
            if (i) return Lo(t, i), { isStateChanged: !0, changedSubject: i };
            const n = t.getNearestEdge(e);
            if (n) return Mo(t, n), { isStateChanged: !0, changedSubject: n };
        ...
        const Lo = (t, e) => {
            Co(t), Io(e, o.SELECTED, { isStateOverride: !0 });
          },
          Mo = (t, e) => {
            Co(t), zo(e, o.SELECTED, { isStateOverride: !0 });
          },
          Co = (t) => {
            const e = t.getNodes((t) => t.isSelected());
            for (let t = 0; t < e.length; t++) e[t].clearState();
            const i = t.getEdges((t) => t.isSelected());
            for (let t = 0; t < i.length; t++) i[t].clearState();
            return { changedCount: e.length + i.length };
          },
          No = (t, e) => {
            Oo(t), Io(e, o.HOVERED);
          },
          Oo = (t) => {
            const e = t.getNodes((t) => t.isHovered());
            for (let t = 0; t < e.length; t++) e[t].clearState();
            const i = t.getEdges((t) => t.isHovered());
            for (let t = 0; t < i.length; t++) i[t].clearState();
            return { changedCount: e.length + i.length };
          },
          Io = (t, e, i) => {
            ko(t, i) && (t.state = e),
              t.getInEdges().forEach((t) => {
                t && ko(t, i) && (t.state = e),
                  t.startNode && ko(t.startNode, i) && (t.startNode.state = e);
              }),
              t.getOutEdges().forEach((t) => {
                t && ko(t, i) && (t.state = e),
                  t.endNode && ko(t.endNode, i) && (t.endNode.state = e);
              });
          },
          zo = (t, e, i) => {
            ko(t, i) && (t.state = e),
          ...
          ko = (t, e) => {
            const i = null == e ? void 0 : e.isStateOverride;
            return i || (!i && !t.state);
          },
          Ao = /^#[a-fA-F0-9]{6}$/;
        class Do {
          constructor(t) {
            (this.hex = Ao.test(null != t ? t : "") ? t : "#000000"),
              (this.rgb = Bo(t));
          }
          toString() {
            return this.hex;
          }
          getDarkerColor(t = 0.3) {
            return Do.getColorFromRGB({
              r: this.rgb.r - t * this.rgb.r,
              g: this.rgb.g - t * this.rgb.g,
              b: this.rgb.b - t * this.rgb.b,
            });
          }
          getLighterColor(t = 0.3) {
            return Do.getColorFromRGB({
              r: this.rgb.r + t * (255 - this.rgb.r),
              g: this.rgb.g + t * (255 - this.rgb.g),
              b: this.rgb.b + t * (255 - this.rgb.b),
            });
          }
          getMixedColor(t) {
            return Do.getColorFromRGB({
              r: (this.rgb.r + t.rgb.r) / 2,
              g: (this.rgb.g + t.rgb.g) / 2,
              b: (this.rgb.b + t.rgb.b) / 2,
            });
          }
          isEqual(t) {
            return (
          ...
          static getColorFromRGB(t) {
            const e = Math.round(Math.max(Math.min(t.r, 255), 0)),
              i = Math.round(Math.max(Math.min(t.g, 255), 0)),
              n = Math.round(Math.max(Math.min(t.b, 255), 0));
            return new Do(Ro({ r: e, g: i, b: n }));
          }
        ...
        const Bo = (t) => ({
          ...
          Zo = ["label", "name"],
          jo = { size: 5, color: new Do("#1d87c9") },
          Ho = { color: new Do("#ababab"), width: 0.3 },
          Uo = () => ({
            getNodeStyle: (t) =>
              Object.assign(Object.assign({}, jo), { label: Go(t) }),
            getEdgeStyle: (t) =>
              Object.assign(Object.assign({}, Ho), { label: Go(t) }),
          }),
          Go = (t) => {
        ...
        class Wo {
          constructor(t, e) {
            ...
            (this.container = t),
              (this._events = new $n()),
              (this._graph = new x(void 0, {
                onLoadedImages: () => {
                  this._view.isInitiallyRendered() && this._view.render();
                },
              })),
              this._graph.setDefaultStyle(Uo()),
              (this._context = {
                container: this.container,
                graph: this._graph,
                events: this._events,
                strategy:
                  null !== (i = null == e ? void 0 : e.strategy) && void 0 !== i
                    ? i
                    : new Eo(),
              }),
              (null == e ? void 0 : e.view)
                ? (this._view = e.view(this._context))
                : (this._view = new bo(this._context));
          }
          get data() {
            return this._graph;
          }
          ...
          setView(t) {
            this._graph.getNodeCount() > 0 && this._graph.clearPositions(),
              this._view && this._view.destroy(),
              (this._view = t(this._context));
          }
        }
      })(),
      n
